...
var CurveModelQuasiNewton = /** @class */ (function (_super) {
    __extends(CurveModelQuasiNewton, _super);
    // protected optimizationProblem: OptimizationProblemBSplineR1toR2QuasiNewton
    function CurveModelQuasiNewton() {
    ...
    Object.defineProperty(CurveModelQuasiNewton.prototype, "spline", {
        get: function () {
    ...
    Object.defineProperty(CurveModelQuasiNewton.prototype, "isClosed", {
        get: function () {
            return false;
        },
        enumerable: false,
    ...
    CurveModelQuasiNewton.prototype.setControlPointPosition = function (controlPointIndex, x, y) {
    ...
    CurveModelQuasiNewton.prototype.setSpline = function (spline) {
        this._spline = spline;
        this.notifyObservers();
    };
    CurveModelQuasiNewton.prototype.addControlPoint = function (controlPointIndex) {
    ...
    CurveModelQuasiNewton.prototype.setActiveControl = function () {
        // this.optimizationProblem = new  OptimizationProblemBSplineR1toR2QuasiNewton(this._spline.clone(), this._spline.clone(), this.activeControl)
        // this.optimizer = new Optimizer(this.optimizationProblem)
        this.notifyObservers();
    };
    return CurveModelQuasiNewton;
