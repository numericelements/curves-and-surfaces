...
class ClosedCurveModelQuasiNewton extends AbstractCurveModel_1.AbstractCurveModel {
    ...
    constructor() {
        ...
        this._spline = (0, PeriodicBSplineR1toR2withOpenKnotSequence_1.create_PeriodicBSplineR1toR2)(cp1, knots);
