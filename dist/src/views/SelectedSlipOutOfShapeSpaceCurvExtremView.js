...
class SelectedSlipOutOfShapeSpaceCurvExtremaView extends SelectedDifferentialEventsView_1.SelectedDifferentialEventsView {
    constructor(gl, spline, pointLoc) {
        super(gl);
        this.DOT_SIZE = 0.025;
        this.RED_COLOR = 0 / 255;
        this.GREEN_COLOR = 200 / 255;
        this.BLUE_COLOR = 0 / 255;
