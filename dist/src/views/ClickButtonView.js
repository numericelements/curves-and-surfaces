...
const InsertKnotButtonDialogShader_1 = require("../2DgraphicsItems/InsertKnotButtonDialogShader");
const AbstractMouseSelectableButtonView_1 = require("./AbstractMouseSelectableButtonView");
class ClickButtonView extends AbstractMouseSelectableButtonView_1.AbstractMouseSelectableButtonView {
    constructor(gl) {
        super(gl);
