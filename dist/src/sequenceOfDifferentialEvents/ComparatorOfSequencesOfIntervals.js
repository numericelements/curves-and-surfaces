...
const MaxIntervalVariation_1 = require("./MaxIntervalVariation");
const ErrorLoging_1 = require("../errorProcessing/ErrorLoging");
/* named constants */
const ComparatorOfSequencesDiffEvents_1 = require("./ComparatorOfSequencesDiffEvents");
const ComparatorOfSequencesDiffEvents_2 = require("./ComparatorOfSequencesDiffEvents");
class ComparatorOfSequencesOfIntervals {
    constructor(sequenceOfIntervals1, sequenceOfIntervals2) {
    ...
    get sequenceOfIntervals1() {
        return this._sequenceOfIntervals1;
    }
    get sequenceOfIntervals2() {
        return this._sequenceOfIntervals2;
    }
    indexIntervalMaximalVariationUnderForwardScan(candidateEvent, nbEvents) {
    ...
    indexIntervalMaximalVariationUnderReverseScan(candidateEvent, nbEvents) {
        if (this.maxVariationInSeq1.index !== ComparatorOfSequencesDiffEvents_2.RETURN_ERROR_CODE) {
            this.maxVariationInSeq1 = new MaxIntervalVariation_1.MaxIntervalVariation();
        }
        this.checkCandidateIndexInReferenceSequence(candidateEvent, nbEvents);
    ...
    checkCandidateIndexInReferenceSequence(CandidateEvent, nbEvents) {
        if (nbEvents === ComparatorOfSequencesDiffEvents_1.ONE_CURVEXT_EVENT_APPEAR_IN_EXTREME_INTERVAL && CandidateEvent >= this._sequenceOfIntervals1.sequence.length) {
            let error = new ErrorLoging_1.ErrorLog(this.constructor.name, "checkCandidateIndexInReferenceSequence", "Invalid index to scan sequence1 of intervals: out of bounds.");
            error.logMessage();
        }
            ...
            let error = new ErrorLoging_1.ErrorLog(this.constructor.name, "checkCandidateIndexInReferenceSequence", "Invalid index to scan sequence2 of intervals: out of bounds.");
            error.logMessage();
        }
    }
}
