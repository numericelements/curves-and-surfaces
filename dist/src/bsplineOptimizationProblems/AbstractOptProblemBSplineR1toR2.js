...
const BernsteinDecompositionR1toR1_1 = require("../newBsplines/BernsteinDecompositionR1toR1");
...
class AbstractOptProblemBSplineR1toR2 {
    ...
    get inflectionTotalNumberOfConstraints() {
    ...
    get curvatureExtremaConstraintsSign() {
        return this._curvatureExtremaConstraintsSign.slice();
    }
    get curvatureNumeratorCP() {
        return this._curvatureNumeratorCP.slice();
    }
    get curvatureDerivativeNumeratorCP() {
    ...
    get analyticHighOrderCurveDerivatives() {
        return this._analyticHighOrderCurveDerivatives;
    }
    get previousAnalyticHighOrderCurveDerivatives() {
        return this._previousAnalyticHighOrderCurveDerivatives;
    }
    set curvatureDerivativeNumeratorCP(curvatureDerivativeNumeratorCP) {
    ...
    expensiveComputation(spline) {
        ...
        let bdsxuuu = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        let bdsyuuu = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        let h1 = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        let h2 = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        let h3 = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
    ...
    initExpansiveComputations() {
        const controlPointArray = [];
        const bdsxu = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        const bdsyu = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        const bdsxuu = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        const bdsyuu = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        const bdsxuuu = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        const bdsyuuu = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        const h1 = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        const h2 = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        const h3 = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        const h4 = new BernsteinDecompositionR1toR1_1.BernsteinDecompositionR1toR1(controlPointArray);
        return {
            bdsxu: bdsxu,
            bdsyu: bdsyu,
            bdsxuu: bdsxuu,
    ...
    curvatureDerivativeNumeratorPreviousIteration() {
    ...
    compute_f(curvatureNumerator, inflectionConstraintsSign, inflectionInactiveConstraints, curvatureDerivativeNumerator, curvatureExtremaConstraintsSign, curvatureExtremaInactiveConstraints) {
        ...
        if (this._shapeSpaceDiffEventsStructure.activeControlInflections && this._shapeSpaceDiffEventsStructure.activeControlCurvatureExtrema) {
            ...
            const warning = new ErrorLoging_1.WarningLog(this.constructor.name, "compute_f", "active control set to none: unable to compute f.");
            warning.logMessage();
            f[0] = 0;
        }
        return f;
