...
const PeriodicBSplineR1toR1_1 = require("../newBsplines/PeriodicBSplineR1toR1");
...
class OptProblemPeriodicBSplineR1toR2 extends AbstractOptProblemBSplineR1toR2_1.AbstractOptProblemBSplineR1toR2 {
...
class OptProblemPeriodicBSplineR1toR2NoInactiveConstraints extends OptProblemPeriodicBSplineR1toR2 {
    constructor(splineInitial, shapeSpaceDiffEventsStructure) {
        super(splineInitial, shapeSpaceDiffEventsStructure);
    }
    computeInactiveConstraints(controlPoints) {
