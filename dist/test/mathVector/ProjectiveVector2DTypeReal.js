...
describe('Projective vector 2D in real vector space: generation and operators in this vector space', () => {
    ...
    describe('Constructor', () => {
        it(`can generate a default projective real vector into the default 3D projective vector space`, () => {
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal();
            (0, chai_1.expect)(projRealVector.coordinates.length).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.coordinates).to.eql([0, 0, 1]);
            ...
            (0, chai_1.expect)(projRealVector.getCoordinate(2)).to.eql(new Weight_1.Weight().value);
            ...
            (0, chai_1.expect)(projRealVector.vectorType).to.eql(VectorTypeTags_1.PROJECTIVEVECTOR2D);
        ...
        it(`can generate an arbitrary projective real vector with default weight into the default 3D projective vector space`, () => {
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(-1, 2);
            (0, chai_1.expect)(projRealVector.coordinates.length).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.coordinates).to.eql([-1, 2, 1]);
            (0, chai_1.expect)(projRealVector.dimension).to.eql(dimension);
        ...
        it(`can generate an arbitrary projective real vector with prescribed weight into the default 3D vector space`, () => {
            ...
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(-1, 2, weight);
            (0, chai_1.expect)(projRealVector.coordinates.length).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.coordinates).to.eql([-1, 2, 2]);
            (0, chai_1.expect)(projRealVector.dimension).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.getCoordinate(0)).to.eql(-1);
            (0, chai_1.expect)(projRealVector.getCoordinate(1)).to.eql(2);
            (0, chai_1.expect)(projRealVector.getCoordinate(2)).to.eql(weight.value);
            (0, chai_1.expect)(projRealVector.weight.strictlyPositive).to.eql(true);
        ...
        it(`can generate a default projective real vector with a default weight into a user-defined 3D vector space`, () => {
            ...
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(vSpace);
            (0, chai_1.expect)(projRealVector.coordinates.length).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.coordinates).to.eql([0, 0, 1]);
            (0, chai_1.expect)(projRealVector.dimension).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.getCoordinate(0)).to.eql(0);
        ...
        it(`can generate an arbitrary projective real vector with default weight into a user-defined 3D vector space`, () => {
            const vSpace = new ProjectiveVectorSpace_1.ProjectiveVectorSpace(dimension);
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, -2, vSpace);
            (0, chai_1.expect)(projRealVector.coordinates.length).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.coordinates).to.eql([1, -2, 1]);
            (0, chai_1.expect)(projRealVector.dimension).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.getCoordinate(0)).to.eql(1);
        ...
        it(`can generate an arbitrary projective real vector with prescribed weight into a user-defined 3D vector space`, () => {
            const weight = new Weight_1.Weight(2);
            const vSpace = new ProjectiveVectorSpace_1.ProjectiveVectorSpace(dimension);
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, -2, weight, vSpace);
            (0, chai_1.expect)(projRealVector.coordinates.length).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.coordinates).to.eql([1, -2, weight.value]);
            (0, chai_1.expect)(projRealVector.dimension).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.getCoordinate(0)).to.eql(1);
            (0, chai_1.expect)(projRealVector.getCoordinate(1)).to.eql(-2);
            (0, chai_1.expect)(projRealVector.getCoordinate(2)).to.eql(weight.value);
        ...
        it(`can generate a default projective real vector with prescribed weight management ${ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights} into the default 3D vector space`, () => {
            ...
            (0, chai_1.expect)(projRealVector.getCoordinate(0)).to.eql(0);
            (0, chai_1.expect)(projRealVector.getCoordinate(1)).to.eql(0);
            (0, chai_1.expect)(projRealVector.getCoordinate(2)).to.eql(1);
        ...
        it(`can generate a default projective real vector with prescribed weight management ${ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights} and null weight`, () => {
            const vSpace = new ProjectiveVectorSpace_1.ProjectiveVectorSpace(dimension, ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights, true);
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 2, new Weight_1.Weight(0, false), vSpace);
            (0, chai_1.expect)(projRealVector.vectorSpace.isDefault).to.eql(true);
            let weightMgmt = projRealVector.vectorSpace.weightManagement;
            (0, chai_1.expect)(weightMgmt).to.eql(ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights);
            (0, chai_1.expect)(projRealVector.coordinates.length).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.coordinates).to.eql([1, 2, 0]);
            (0, chai_1.expect)(projRealVector.dimension).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.getCoordinate(0)).to.eql(1);
            (0, chai_1.expect)(projRealVector.getCoordinate(1)).to.eql(2);
        ...
        it(`can generate user-defined projective real vectors with prescribed weight management ${ProjectiveVectorSpace_2.WeightManagement.SomeNullWeights} and null or strictly positive weights`, () => {
            ...
            const projRealVector1 = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(0, -2, vSpace);
            (0, chai_1.expect)(projRealVector1.getCoordinate(0)).to.eql(0);
            (0, chai_1.expect)(projRealVector1.getCoordinate(1)).to.eql(-2);
            (0, chai_1.expect)(projRealVector1.getCoordinate(2)).to.eql(1);
            (0, chai_1.expect)(projRealVector1.weight.strictlyPositive).to.eql(true);
            // vector with possibly null weight
            const projRealVector2 = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(0, -2, new Weight_1.Weight(2, false), vSpace);
            (0, chai_1.expect)(projRealVector2.getCoordinate(0)).to.eql(0);
            (0, chai_1.expect)(projRealVector2.getCoordinate(1)).to.eql(-2);
            (0, chai_1.expect)(projRealVector2.getCoordinate(2)).to.eql(2);
        ...
        it(`cannot set a null weight, or a weight that can become null, to a vector with weight management ${ProjectiveVectorSpace_2.WeightManagement.AllStrictlyPositiveWeights} and default 3D projective real vector space`, () => {
            ...
            (0, chai_1.expect)(() => new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 1, new Weight_1.Weight(0, false), vSpace)).to.throw(Vectors_1.EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
            (0, chai_1.expect)(() => new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 1, new Weight_1.Weight(2, false), vSpace)).to.throw(Vectors_1.EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
        });
        it(`cannot set a null weight, or a weight that can become null, to a vector with weight management ${ProjectiveVectorSpace_2.WeightManagement.AllStrictlyPositiveWeights} and default 3D projective real vector space`, () => {
            (0, chai_1.expect)(() => new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 1, new Weight_1.Weight(0, false))).to.throw(Vectors_1.EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
            (0, chai_1.expect)(() => new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 1, new Weight_1.Weight(2, false))).to.throw(Vectors_1.EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
        });
        ...
        it(`cannot set a strictly positive weight to a vector with weight management ${ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights} and default 3D projective real vector space`, () => {
            const vSpace = new ProjectiveVectorSpace_1.ProjectiveVectorSpace(dimension, ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights, true);
            (0, chai_1.expect)(vSpace.isDefault).to.eql(true);
            (0, chai_1.expect)(() => new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 2, new Weight_1.Weight(3, true), vSpace)).to.throw(Vectors_1.EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
        });
        ...
        it(`can generate a vector with weight management ${ProjectiveVectorSpace_2.WeightManagement.AllStrictlyPositiveWeights} and a weight value smaller than ${ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE}`, () => {
            ...
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 2, smallWeight);
            (0, chai_1.expect)(projRealVector.vectorSpace.isDefault).to.eql(true);
            let weightMgmt = projRealVector.vectorSpace.weightManagement;
            (0, chai_1.expect)(weightMgmt).to.eql(ProjectiveVectorSpace_2.WeightManagement.AllStrictlyPositiveWeights);
            (0, chai_1.expect)(projRealVector.coordinates.length).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.coordinates).to.eql([1, 2, ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE / 2]);
            (0, chai_1.expect)(projRealVector.dimension).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.getCoordinate(0)).to.eql(1);
            (0, chai_1.expect)(projRealVector.getCoordinate(1)).to.eql(2);
            (0, chai_1.expect)(projRealVector.getCoordinate(2)).to.eql(ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE / 2);
            (0, chai_1.expect)(projRealVector.weight.strictlyPositive).to.eql(true);
        ...
        it(`can generate a vector with weight management ${ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights} and an input weight value smaller than ${ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE}`, () => {
            ...
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 2, smallWeight, vectorSpace);
            (0, chai_1.expect)(projRealVector.vectorSpace.isDefault).to.eql(true);
            let weightMgmt = projRealVector.vectorSpace.weightManagement;
            (0, chai_1.expect)(weightMgmt).to.eql(ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights);
            (0, chai_1.expect)(projRealVector.coordinates.length).to.eql(dimension);
        ...
        it(`can generate a vector with weight management ${ProjectiveVectorSpace_2.WeightManagement.SomeNullWeights} and an input weight value smaller than ${ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE}`, () => {
            ...
            const projRealVector1 = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 2, smallWeight1, vectorSpace);
            (0, chai_1.expect)(projRealVector1.coordinates).to.eql([1, 2, ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE / 2]);
            (0, chai_1.expect)(projRealVector1.getCoordinate(0)).to.eql(1);
            (0, chai_1.expect)(projRealVector1.getCoordinate(1)).to.eql(2);
            (0, chai_1.expect)(projRealVector1.getCoordinate(2)).to.eql(ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE / 2);
            (0, chai_1.expect)(projRealVector1.weight.strictlyPositive).to.eql(true);
    ...
    describe('Accessors', () => {
        ...
        it(`can get the weight of a vector as w parameter of a vector into a default vector space with weight management ${ProjectiveVectorSpace_2.WeightManagement.AllStrictlyPositiveWeights}`, () => {
            ...
            const weight1 = 3;
            const projRealVector1 = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 2, new Weight_1.Weight(weight1));
        ...
        it(`can get the weight as w parameter of a vector into a default vector space with weight management ${ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights}`, () => {
            const vSpace = new ProjectiveVectorSpace_1.ProjectiveVectorSpace(dimension, ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights);
            const weight = 0;
            const projRealVector = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 2, new Weight_1.Weight(weight, false), vSpace);
            (0, chai_1.expect)(projRealVector.w).to.eql(weight);
            (0, chai_1.expect)(projRealVector.dimension).to.eql(dimension);
            (0, chai_1.expect)(projRealVector.vectorType).to.eql(VectorTypeTags_1.PROJECTIVEVECTOR2D);
            (0, chai_1.expect)(projRealVector.spaceType).to.eql(BSplineR1toRn_1.VectorSpaceType.PROJECTIVE);
        ...
        it(`can get the weight as w parameter of a vector into a default vector space with weight management ${ProjectiveVectorSpace_2.WeightManagement.SomeNullWeights}`, () => {
            ...
            const weight1 = 3;
            const projRealVector1 = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(1, 2, new Weight_1.Weight(weight1, true), vSpace);
            (0, chai_1.expect)(projRealVector1.w).to.eql(weight1);
            (0, chai_1.expect)(projRealVector1.dimension).to.eql(dimension);
            (0, chai_1.expect)(projRealVector1.vectorType).to.eql(VectorTypeTags_1.PROJECTIVEVECTOR2D);
    ...
    describe('Methods', () => {
        it(`can get the vector descriptor as a string`, () => {
            ...
            const projectiveVector1 = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(coordinates[0], coordinates[1], vSpace1);
            (0, chai_1.expect)(projectiveVector1.dimension).to.eql(dimension);
            (0, chai_1.expect)(projectiveVector1.vectorType).to.eql(VectorTypeTags_1.PROJECTIVEVECTOR2D);
            ...
            (0, chai_1.expect)(string).to.eql(VectorTypeTags_1.PROJECTIVEVECTOR2D + `(${coordinates[0]}, ${coordinates[1]}, ${new Weight_1.Weight().toString()})` + ` ` + projectiveVector1.vectorSpace.toString());
        });
        it(`cannot get a null norm with weight management ${ProjectiveVectorSpace_2.WeightManagement.AllStrictlyPositiveWeights} because a null projective vector cannot be created`, () => {
            ...
            const vSpace = new ProjectiveVectorSpace_1.ProjectiveVectorSpace(dimension, ProjectiveVectorSpace_2.WeightManagement.AllStrictlyPositiveWeights);
            (0, chai_1.expect)(() => new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(coordinates[0], coordinates[1], new Weight_1.Weight(0, false), vSpace)).to.throw(Vectors_1.EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
        });
        it(`can get a null norm with weight management ${ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights}`, () => {
            const coordinates = [0, 0];
            const vSpace = new ProjectiveVectorSpace_1.ProjectiveVectorSpace(dimension, ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights);
            const projectiveVector1 = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(coordinates[0], coordinates[1], new Weight_1.Weight(0, false), vSpace);
            (0, chai_1.expect)(projectiveVector1.dimension).to.eql(dimension);
            (0, chai_1.expect)(projectiveVector1.vectorType).to.eql(VectorTypeTags_1.PROJECTIVEVECTOR2D);
            (0, chai_1.expect)(projectiveVector1.spaceType).to.eql(BSplineR1toRn_1.VectorSpaceType.PROJECTIVE);
            (0, chai_1.expect)(projectiveVector1.vectorSpace.isDefault).to.eql(false);
        ...
        it(`cannot normalize a vector with a norm smaller than ${ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE} and weight management ${ProjectiveVectorSpace_2.WeightManagement.AllStrictlyPositiveWeights}`, () => {
            const coordinates = [0, 0];
            const vSpace = new ProjectiveVectorSpace_1.ProjectiveVectorSpace(dimension, ProjectiveVectorSpace_2.WeightManagement.AllStrictlyPositiveWeights);
            const projectiveVector1 = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(coordinates[0], coordinates[1], new Weight_1.Weight(ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE / 2), vSpace);
            (0, chai_1.expect)(projectiveVector1.dimension).to.eql(dimension);
            (0, chai_1.expect)(projectiveVector1.vectorType).to.eql(VectorTypeTags_1.PROJECTIVEVECTOR2D);
            (0, chai_1.expect)(projectiveVector1.spaceType).to.eql(BSplineR1toRn_1.VectorSpaceType.PROJECTIVE);
            (0, chai_1.expect)(projectiveVector1.vectorSpace.isDefault).to.eql(false);
        ...
        it(`cannot normalize a vector with a norm smaller than ${ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE} and weight management ${ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights}`, () => {
            const coordinates = [0, 0];
            const vSpace = new ProjectiveVectorSpace_1.ProjectiveVectorSpace(dimension, ProjectiveVectorSpace_2.WeightManagement.AllPositiveWeights);
            const projectiveVector1 = new ProjectiveVector2DTypeReal_1.ProjectiveVector2DTypeReal(coordinates[0], coordinates[1], new Weight_1.Weight(ProjectiveVectorSpace_2.NULL_WEIGHT_TOLERANCE / 2, false), vSpace);
            (0, chai_1.expect)(projectiveVector1.dimension).to.eql(dimension);
            (0, chai_1.expect)(projectiveVector1.vectorType).to.eql(VectorTypeTags_1.PROJECTIVEVECTOR2D);
            (0, chai_1.expect)(projectiveVector1.spaceType).to.eql(BSplineR1toRn_1.VectorSpaceType.PROJECTIVE);
            (0, chai_1.expect)(projectiveVector1.vectorSpace.isDefault).to.eql(false);
