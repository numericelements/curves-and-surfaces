...
const ModifiedDifferentialEvents_1 = require("../../src/sequenceOfDifferentialEvents/ModifiedDifferentialEvents");
...
describe('ComparatorOfSequencesOfDiffEvents', () => {
    describe('locateIntervalAndNumberOfCurvExEventChanges', () => {
        it('throws warning only if the sequences of differential events have the same length and contain one inflection, at least, when trying to locate curvature extrema changes', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.1, 0.75], [0.5]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.85], [0.45]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            (0, chai_1.expect)(() => comparator.checkConsistencyModifiedEvents()).not.to.throw();
            (0, chai_1.expect)(() => comparator.locateIntervalAndNumberOfCurvExEventChanges()).not.to.throw();
        });
        it('throws error if the sequences of differential events have not an even number of curvature extrema changes between two successive inflections', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.1, 0.5, 0.75], [0.3, 0.85]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.85], [0.25, 0.9]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateIntervalAndNumberOfCurvExEventChanges();
            (0, chai_1.expect)(comparator.sequenceDiffEvents1.indicesOfInflections[0]).to.eql(1);
            (0, chai_1.expect)(comparator.sequenceDiffEvents1.indicesOfInflections[1]).to.eql(4);
        ...
        it('generates the number and interval of curvature events changes when one curvature extremum appears', () => {
            ...
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateIntervalAndNumberOfCurvExEventChanges();
            (0, chai_1.expect)(comparator.modifiedCurvExEvents.length, 'nb curvEx modified: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedCurvExEvents[0].indexInflection, 'index interval modified: ').to.eql(0);
            (0, chai_1.expect)(comparator.modifiedCurvExEvents[0].nbEvents, 'nb curvEx modified: ').to.eql(1);
        });
        ...
        it('generates the number and interval of curvature events changes when two curvature extrema disappear between inflections', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.25, 0.4, 0.55], [0.1, 0.8]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.45], [0.15, 0.75]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateIntervalAndNumberOfCurvExEventChanges();
            (0, chai_1.expect)(comparator.modifiedCurvExEvents.length, 'nb curvEx modified: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedCurvExEvents[0].indexInflection, 'index interval modified: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedCurvExEvents[0].nbEvents, 'nb curvEx modified: ').to.eql(-2);
        });
    });
    describe('checkConsistencyModifiedEvents', () => {
        ...
        (0, chai_1.expect)(sum).to.not.eql(0);
        // error is thrown by ErrorLog class
        // expect( () => comparator.checkConsistencySumModifiedEvents()).to.throw();
    });
    describe('checkConsistencyModifiedEvents', () => {
        const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.3, 0.5], [0.2, 0.7]);
        const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.3], [0.2, 0.7]);
        const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
        comparator.modifiedCurvExEvents = [];
    ...
    describe('locateIntervalAndNumberOfInflectionEventChanges', () => {
        it('does not throw an error if the sequences of differential events have changes of curvature extrema and inflections', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.5], [0.25, 0.9]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            (0, chai_1.expect)(() => comparator.locateIntervalAndNumberOfInflectionEventChanges()).not.to.throw();
        });
        it('generates the index of curvature event when two inflections appear', () => {
            ...
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.5], [0.45, 0.55]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateIntervalAndNumberOfInflectionEventChanges();
            (0, chai_1.expect)(comparator.modifiedInflectionEvents.length, 'nb inflections modified: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].indexCurvatureEx, 'index curvEx of modification: ').to.eql(0);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].nbEvents, 'nb inflections modified: ').to.eql(2);
        });
        it('generates the index of curvature event when one inflection appears into a unique interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([], [0.15]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateIntervalAndNumberOfInflectionEventChanges();
            (0, chai_1.expect)(comparator.modifiedInflectionEvents.length, 'nb inflections modified: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].indexCurvatureEx, 'index curvEx of modification: ').to.eql(0);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].nbEvents, 'nb inflections modified: ').to.eql(1);
        });
        it('generates the index of curvature event when one inflection appears into the left extreme interval', () => {
            ...
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.4], [0.15]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateIntervalAndNumberOfInflectionEventChanges();
            (0, chai_1.expect)(comparator.modifiedInflectionEvents.length, 'nb inflections modified: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].indexCurvatureEx, 'index curvEx of modification: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].nbEvents, 'nb inflections modified: ').to.eql(1);
        });
        it('generates the index of curvature event when one inflection appears into the right extreme interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.4], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.4], [0.85]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateIntervalAndNumberOfInflectionEventChanges();
            (0, chai_1.expect)(comparator.modifiedInflectionEvents.length, 'nb inflections modified: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].indexCurvatureEx, 'index curvEx of modification: ').to.eql(0);
        ...
        it('generates the index of curvature event when two inflections appear into an intermediate interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.1, 0.3, 0.4], [0.2]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.15, 0.3, 0.45], [0.25, 0.35, 0.55]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateIntervalAndNumberOfInflectionEventChanges();
            (0, chai_1.expect)(comparator.modifiedInflectionEvents.length, 'nb inflections modified: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].indexCurvatureEx, 'index curvEx of modification: ').to.eql(3);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].nbEvents, 'nb inflections modified: ').to.eql(2);
        });
        it('generates the index of curvature events when two inflections appear into the left and the right extreme intervals', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.1, 0.3, 0.4], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.15, 0.3, 0.45], [0.05, 0.9]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateIntervalAndNumberOfInflectionEventChanges();
            (0, chai_1.expect)(comparator.modifiedInflectionEvents.length, 'nb inflections modified: ').to.eql(2);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].indexCurvatureEx, 'index curvEx of modification: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[0].nbEvents, 'nb inflections modified: ').to.eql(1);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[1].indexCurvatureEx, 'index curvEx of modification: ').to.eql(3);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents[1].nbEvents, 'nb inflections modified: ').to.eql(1);
        });
    });
    describe('locateNeiboringEventsUnderInflectionEventChanges', () => {
        it('does not generate any neighboring event if there is no change of inflections and generate a warning', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.2, 0.5], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.2, 0.5], []);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'nb neighboringEvents: ').to.eql(0);
        });
        it('throws an error if the number of modified inflections does not match the predefined list', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.2, 0.5], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.2, 0.5], [0.1, 0.3, 0.9]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
        ...
        it('can return the neighboring event when an inflection event disappears alone at the left hand side of a unique interval', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionLeftBoundaryDisappear);
        });
        ...
        it('can return the neighboring event when an inflection event disappears alone at the right hand side of a unique interval', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionRightBoundaryDisappear);
        });
        it('can return the neighboring event when an inflection event disappears alone at the right hand side of a unique interval while there are other curvature events in this interval', () => {
            ...
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(2);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionRightBoundaryDisappear);
        });
        ...
        it('can return the neighboring event when an inflection event disappears alone at the extreme right hand side interval', () => {
            ...
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(3);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionRightBoundaryDisappear);
        });
        it('can return the neighboring event when an inflection event appears alone at the left hand side of a unique interval', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionLeftBoundaryAppear);
        });
        ...
        it('can return the neighboring event when an inflection event appears alone at the extreme right hand side interval', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(3);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionRightBoundaryAppear);
        });
        it('can return the neighboring event when an inflection event disappears and is adjacent to a unique curvature extremum of the interval', () => {
            ...
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionsCurvatureExtremumDisappear);
        });
        ...
        it('can return the neighboring event when an inflection event appears and is adjacent to a curvature extremum located at the right hand side of the interval', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionsCurvatureExtremumAppear);
        });
    ...
    describe('locateNeiboringEventsUnderInflectionEventChanges', () => {
        it('does not generate any neighboring event if there is no change of curvature extremum and generate a warning', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.2, 0.5], [0.8]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.2, 0.5], [0.75]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'nb neighboringEvents: ').to.eql(0);
        });
        it('throws an error if the number of modified curvature extrema does not match the predefined list', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.2, 0.5, 0.75], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([], []);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.modifiedCurvExEvents = [];
        ...
        it('can return the neighboring event when a curvature extremum appears alone in the left extreme interval', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurExtremumLeftBoundaryAppear);
        });
        it('can return the neighboring event when a curvature extremum appears alone in the right extreme interval', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(2);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurExtremumRightBoundaryAppear);
        });
        it('can return the neighboring event when a curvature extremum disappears in the left extreme interval leaving other curvature events in that interval', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurExtremumLeftBoundaryDisappear);
        });
        it('can return the neighboring event when a curvature extremum disappears in the right extreme interval where there is already a curvature event', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(2);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurExtremumRightBoundaryDisappear);
        });
        ...
        it('can return the neighboring event when a curvature extremum disappears at the right hand side of the interval where there is already a curvature event', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurExtremumRightBoundaryDisappear);
        });
        it('can return the neighboring event when two curvature extrema appear together into the unique interval', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurvatureExtremaAppear);
        });
        ...
        it('can return the neighboring event when two curvature extrema disappear into the left interval already populated with others', () => {
            ...
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurvatureExtremaDisappear);
        });
    ...
    describe('locateNeiboringEvents', () => {
        it('does not generate any modified event if curvature extrema and inflections are modified simultaneously', () => {
            ...
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.5], [0.45, 0.55]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            (0, chai_1.expect)(comparator.modifiedInflectionEvents.length, 'nb inflections modified: ').to.eql(0);
            (0, chai_1.expect)(comparator.modifiedCurvExEvents.length, 'nb curvEx modified: ').to.eql(0);
        });
        it('behavior when one curvature extremum disappear at the left hand side and is replaced by one inflection at the left hand side when the starting interval is a unique principal interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.95], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.94], [0.05]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurvExtremumLeftBoundaryDisappearInflectionAppear);
        });
        it('behavior when one curvature extremum disappear at the left hand side and is replaced by one inflection at the left hand side when the starting interval is the left hand side interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.2, 0.95], [0.5]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.25, 0.93], [0.05, 0.6]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
        ...
        it('behavior when one curvature extremum disappear at the right hand side and is replaced by one inflection at the right hand side when the starting interval is a unique principal interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.95], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.04], [0.95]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurvExtremumRightBoundaryDisappearInflectionAppear);
        });
        it('behavior when one curvature extremum disappear at the right hand side and is replaced by one inflection at the right hand side when the starting interval is the right hand side interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.70, 0.95], [0.5]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.04, 0.75], [0.6, 0.95]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
        ...
        it('behavior when one inflection disappear at the left hand side and is replaced by one curvature extremum at the left hand side when the starting interval is a unique principal interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.95], [0.05]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.94], []);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionLeftBoundaryDisappearCurExtremumAppear);
        });
        it('behavior when one inflection disappear at the left hand side and is replaced by one curvature extremum at the left hand side when the starting interval is the left hand side interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.2, 0.95], [0.05, 0.5]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.25, 0.93], [0.6]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
        ...
        it('behavior when one inflection disappear at the right hand side and is replaced by one curvature extremum at the right hand side when the starting interval is a unique principal interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05], [0.95]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.04, 0.92], []);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringInflectionRightBoundaryDisappearCurExtremumAppear);
        });
        it('behavior when one inflection disappear at the right hand side and is replaced by one curvature extremum at the right hand side when the starting interval is the right hand side interval', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.70], [0.5, 0.95]);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.04, 0.75, 0.95], [0.6]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(1);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
        ...
        it('behavior when one curvature extremum disappears at the left hand side and one inflection appears at the right hand side', () => {
            const seqDif1 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.05, 0.2], []);
            const seqDif2 = new SequenceOfDifferentialEvents_1.SequenceOfDifferentialEvents([0.25], [0.95]);
            const comparator = new ComparatorOfSequencesDiffEvents_1.ComparatorOfSequencesOfDiffEvents(seqDif1, seqDif2);
            comparator.locateNeiboringEvents();
            (0, chai_1.expect)(comparator.neighboringEvents.length, 'neighboringEvent length: ').to.eql(2);
            (0, chai_1.expect)(comparator.neighboringEvents[0].index, 'neighboringEvent.index: ').to.eql(0);
            (0, chai_1.expect)(comparator.neighboringEvents[0].type, 'neighboringEvent.type: ').to.eql(NeighboringEvents_1.NeighboringEventsType.neighboringCurExtremumLeftBoundaryDisappear);
        });
    });
