...
describe('IncreasingPeriodicKnotSequenceClosedCurve', () => {
    ...
    describe('Methods', () => {
        ...
        it('can convert the increasing uniform periodic knot sequence to a strictly increasing periodic knot sequence with constructor type ' + INCREASINGPERIODICKNOTSEQUENCE, () => {
        ...
        it('check knot sequence properties after knot insertion', () => {
            ...
            expect(seq1.allAbscissae[0]).to.eql(OPEN_KNOT_SEQUENCE_ORIGIN)
        });
