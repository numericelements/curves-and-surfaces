...
describe('OpBSplineR1toR2', () => {
    ...
    it('returns gradient_f such that a dot product of a rigid motion equal zero', () => {
        let splineTarget = create_BSplineR1toR2([[-0.5, 10], [-0.25, 5], [0.25, 2], [0.5, 0]], [0, 0, 0, 0, 1, 1, 1, 1])
        let splineInitial = create_BSplineR1toR2([[-0.5, 10], [-0.25, 5], [0.25, 2], [0.5, 0]], [0, 0, 0, 0, 1, 1, 1, 1])
        
        /*
        splineTarget = splineTarget.elevateDegree()
        splineInitial = splineInitial.elevateDegree()
        splineTarget = splineTarget.elevateDegree()
        splineInitial = splineInitial.elevateDegree()
        splineTarget = splineTarget.elevateDegree()
        splineInitial = splineInitial.elevateDegree()
    ...
    it('has no nan in constraint vector', () => {
        ...
        let g = o.curvatureDerivativeNumerator(e)
    ...
    it('has no zeros in constraint vector', () => {
        ...
        let o = new OpBSplineR1toR2(splineTarget, splineInitial)
        let e = o.expensiveComputation(o.spline)
        let constraint_vector = o.curvatureDerivativeNumerator(e)
    ...
    it('has no nan in gradient constraint matrix', () => {
        ...
        const cdn = o.curvatureDerivativeNumerator(e)
        const cs = o.computeConstraintsSign(cdn)
        const m = o.compute_curvatureDerivativeNumerator_gradient(e, cs, [])
