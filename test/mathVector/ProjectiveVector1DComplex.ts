...
describe('Vector 1D in projective complex vector space: generation and operators in this vector space', () => {
    ...
    describe('Constructor', () => {
        ...
        it(`can generate a default projective complex vector into the default 2D vector space`, () => {
            const projectiveComplexVector = new ProjectiveVector1DComplex();
        ...
        it(`can generate an arbitrary projective complex vector with default weight into the default 2D projective complex vector space`, () => {
            ...
            const projectiveComplexVector = new ProjectiveVector1DComplex(complexCoordinates.real, complexCoordinates.imaginary);
            expect(projectiveComplexVector.coordinates.length).to.eql(dimension);
        ...
        it(`can generate an arbitrary projective complex vector with prescribed complex weight into the default 2D projective complex vector space`, () => {
            ...
            const projectiveComplexVector = new ProjectiveVector1DComplex(complexCoordinates.real, complexCoordinates.imaginary, realWeight, imaginaryWeight);
        ...
        it(`can generate an arbitrary projective complex vector with prescribed complex value and default weight into the default 2D projective complex vector space`, () => {
            const complexCoordinates = new Complex(-1, 4);
            const projectiveComplexVector = new ProjectiveVector1DComplex(complexCoordinates);
            expect(projectiveComplexVector.coordinates.length).to.eql(dimension);
            expect(projectiveComplexVector.coordinates).to.eql([complexCoordinates, new Complex(DEFAULT_WEIGHT_VALUE, DEFAULT_IMAGINARY_WEIGHT_VALUE)]);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
            expect(projectiveComplexVector.getCoordinate(0)).to.eql(complexCoordinates);
        ...
        it(`can generate an arbitrary projective complex vector with prescribed complex value and weight into the default 2D projective complex vector space`, () => {
            const complexCoordinates = new Complex(-1, 4);
            const projectiveComplexVector = new ProjectiveVector1DComplex(complexCoordinates, complexWeight);
            expect(projectiveComplexVector.coordinates.length).to.eql(dimension);
            expect(projectiveComplexVector.coordinates).to.eql([complexCoordinates, new Complex(complexWeight.real.value, complexWeight.imaginary.value)]);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
            expect(projectiveComplexVector.getCoordinate(0)).to.eql(complexCoordinates);
        ...
        it(`can generate a default projective complex vector with a default complex weight into a user specific 2D vector space`, () => {
            ...
            const projectiveComplexVector = new ProjectiveVector1DComplex(vectorSpace);
            expect(projectiveComplexVector.coordinates).to.eql([new Complex(), new Complex(DEFAULT_WEIGHT_VALUE, DEFAULT_IMAGINARY_WEIGHT_VALUE)]);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
            expect(projectiveComplexVector.getCoordinate(0)).to.eql(new Complex());
            expect(projectiveComplexVector.getCoordinate(1)).to.eql(new Complex(DEFAULT_WEIGHT_VALUE, DEFAULT_IMAGINARY_WEIGHT_VALUE));
        ...
        it(`can generate an arbitrary projective complex vector with default weight into a user specific 2D complex vector space`, () => {
            const vectorSpace = new ProjectiveComplexVectorSpace(MIN_DIMENSION_PROJECTIVECOMPLEXVECTORSPACE);
            const complexCoordinates = new Complex(-1, 4);
            const projectiveComplexVector = new ProjectiveVector1DComplex(complexCoordinates.real, complexCoordinates.imaginary, vectorSpace);
            expect(projectiveComplexVector.coordinates.length).to.eql(dimension);
            expect(projectiveComplexVector.coordinates).to.eql([complexCoordinates, new Complex(DEFAULT_WEIGHT_VALUE, DEFAULT_IMAGINARY_WEIGHT_VALUE)]);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
            expect(projectiveComplexVector.getCoordinate(0)).to.eql(complexCoordinates);
        ...
        it(`can generate a projective complex vector with prescribed coordinates into a user specific 2D complex vector space`, () => {
            const vectorSpace = new ProjectiveComplexVectorSpace(MIN_DIMENSION_PROJECTIVECOMPLEXVECTORSPACE);
            const complexCoordinates = new Complex(-1, 3);
            const projectiveComplexVector = new ProjectiveVector1DComplex(complexCoordinates.real, complexCoordinates.imaginary, realWeight, imaginaryWeight, vectorSpace);
            expect(projectiveComplexVector.coordinates).to.eql([complexCoordinates, new Complex(complexWeight.real.value, complexWeight.imaginary.value)]);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
            expect(projectiveComplexVector.getCoordinate(0)).to.eql(complexCoordinates);
            expect(projectiveComplexVector.getCoordinate(1)).to.eql(new Complex(complexWeight.real.value, complexWeight.imaginary.value));
        ...
        it(`can generate an arbitrary projective complex vector with prescribed complex value and default weight into a user specific 2D projective complex vector space`, () => {
            const vectorSpace = new ProjectiveComplexVectorSpace(MIN_DIMENSION_PROJECTIVECOMPLEXVECTORSPACE);
            const complexCoordinates = new Complex(-1, 4);
            const projectiveComplexVector = new ProjectiveVector1DComplex(complexCoordinates, vectorSpace);
            expect(projectiveComplexVector.coordinates.length).to.eql(dimension);
            expect(projectiveComplexVector.coordinates).to.eql([complexCoordinates, new Complex(DEFAULT_WEIGHT_VALUE, DEFAULT_IMAGINARY_WEIGHT_VALUE)]);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
            expect(projectiveComplexVector.getCoordinate(0)).to.eql(complexCoordinates);
        ...
        it(`can generate an arbitrary projective complex vector with prescribed complex value and weight into a user specific 2D projective complex vector space`, () => {
            const vectorSpace = new ProjectiveComplexVectorSpace(MIN_DIMENSION_PROJECTIVECOMPLEXVECTORSPACE);
            const complexCoordinates = new Complex(-1, 4);
            const projectiveComplexVector = new ProjectiveVector1DComplex(complexCoordinates, complexWeight, vectorSpace);
            expect(projectiveComplexVector.coordinates.length).to.eql(dimension);
            expect(projectiveComplexVector.coordinates).to.eql([complexCoordinates, new Complex(complexWeight.real.value, complexWeight.imaginary.value)]);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
            expect(projectiveComplexVector.getCoordinate(0)).to.eql(complexCoordinates);
        ...
        it(`can generate a default complex projective complex vector with prescribed weight management ${WeightManagement.AllPositiveWeights} into the default projective complex vector space`, () => {
            ...
            const projectiveComplexVector = new ProjectiveVector1DComplex(vSpace);
            expect(projectiveComplexVector.vectorSpace.isDefault).to.eql(true);
        ...
        it(`can generate an arbitrary projective complex vector with prescribed real values and weights with weight management ${WeightManagement.SomeNullWeights} into a user specific 2D projective complex vector space and strictly positive status true`, () => {
            ...
            const projectiveComplexVector = new ProjectiveVector1DComplex(-1, 2, realWeight, imaginaryWeight, vectorSpace);
        ...
        it(`can generate an arbitrary projective complex vector with prescribed complex values and weights with weight management ${WeightManagement.SomeNullWeights} into a user specific 2D projective complex vector space and strictly positive status true`, () => {
            ...
            const projectiveComplexVector = new ProjectiveVector1DComplex(complex1, complexW, vectorSpace);
            const complex2 = new Complex(realWeight.value, imaginaryWeight.value);
            expect(projectiveComplexVector.coordinates.length).to.eql(dimension);
            expect(projectiveComplexVector.coordinates).to.eql([complex1, complex2]);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
        ...
        it(`cannot generate a projective complex vector using real weights of diffrent strictly positive status with prescribed weight management ${WeightManagement.AllPositiveWeights} into the default projective complex vector space`, () => {
            ...
            expect(() => new ProjectiveVector1DComplex(1, -2, new Weight(2), new Weight(3, false), vSpace)).to.throw(EM_STRICTLYPOS_STATUS_INCOMPATIBLE_WEIGHT_MANAGEMENT);
        });
        ...
        it(`cannot generate a projective complex vector using real weights of incorrect strictly positive status with prescribed weight management ${WeightManagement.AllStrictlyPositiveWeights} into the default projective complex vector space`, () => {
            ...
            expect(vSpace.isDefault).to.eql(true);
            expect(vSpace.weightManagement).to.eql(WeightManagement.AllStrictlyPositiveWeights);
            expect(() => new ProjectiveVector1DComplex(1, -2, new Weight(2, false), new Weight(3, false), vSpace)).to.throw(EM_STRICTLYPOS_STATUS_INCOMPATIBLE_WEIGHT_MANAGEMENT);
        });
        ...
        it(`cannot generate a complex projective complex vector using real weights of diffrent strictly positive status with prescribed weight management ${WeightManagement.AllStrictlyPositiveWeights} into the default projective complex vector space`, () => {
            expect(() => new ProjectiveVector1DComplex(1, -2, new Weight(2, false), new Weight(3, false))).to.throw(EM_STRICTLYPOS_STATUS_INCOMPATIBLE_WEIGHT_MANAGEMENT);
        });
        ...
        it(`cannot generate a complex projective complex vector using real weights of incorrect strictly positive status with prescribed weight management ${WeightManagement.AllPositiveWeights} into the default projective complex vector space`, () => {
            ...
            expect(vSpace.isDefault).to.eql(true);
            expect(vSpace.weightManagement).to.eql(WeightManagement.AllPositiveWeights);
            expect(() => new ProjectiveVector1DComplex(1, -2, new Weight(2), new Weight(3), vSpace)).to.throw(EM_STRICTLYPOS_STATUS_INCOMPATIBLE_WEIGHT_MANAGEMENT);
        });
        ...
        it(`cannot generate a projective complex vector using real weights of incorrect strictly positive status of imaginary weight with prescribed weight management ${WeightManagement.AllPositiveWeights} into a user-defined projective complex vector space`, () => {
            ...
            expect(vSpace.isDefault).to.eql(false);
            expect(vSpace.weightManagement).to.eql(WeightManagement.AllPositiveWeights);
            expect(() => new ProjectiveVector1DComplex(1, -2, new Weight(2, false), new Weight(3), vSpace)).to.throw(EM_STRICTLYPOS_STATUS_INCOMPATIBLE_WEIGHT_MANAGEMENT);
        });
        ...
        it(`cannot generate a projective complex vector using a complex weight of incorrect strictly positive status with prescribed weight management ${WeightManagement.AllStrictlyPositiveWeights} into a user-defined projective complex vector space`, () => {
            ...
            expect(vSpace.isDefault).to.eql(false);
            expect(vSpace.weightManagement).to.eql(WeightManagement.AllStrictlyPositiveWeights);
            expect(() => new ProjectiveVector1DComplex(new Complex(1, -2), new ComplexWeight(new Weight(2, false), new Weight(3, false)), vSpace)).to.throw(EM_STRICTLYPOS_STATUS_INCOMPATIBLE_WEIGHT_MANAGEMENT);
        });
        ...
        it(`cannot generate a projective complex vector using a complex weight of incorrect strictly positive status with prescribed weight management ${WeightManagement.AllStrictlyPositiveWeights} into the default projective complex vector space`, () => {
            expect(() => new ProjectiveVector1DComplex(new Complex(1, -2), new ComplexWeight(new Weight(2, false), new Weight(3, false)))).to.throw(EM_STRICTLYPOS_STATUS_INCOMPATIBLE_WEIGHT_MANAGEMENT);
        });
        ...
        it(`cannot generate a projective complex vector using a complex weight of incorrect strictly positive status with prescribed weight management ${WeightManagement.AllPositiveWeights} into a user-defined projective complex vector space`, () => {
            ...
            expect(vSpace.isDefault).to.eql(false);
            expect(vSpace.weightManagement).to.eql(WeightManagement.AllPositiveWeights);
            expect(() => new ProjectiveVector1DComplex(new Complex(1, -2), new ComplexWeight(new Weight(2), new Weight(3)), vSpace)).to.throw(EM_STRICTLYPOS_STATUS_INCOMPATIBLE_WEIGHT_MANAGEMENT);
        });
        ...
        it(`cannot generate a projective complex vector into a default vector space if the user-specified coordinates are not a complex and a complex weight`, () => {
            ...
            expect(() =>  new ProjectiveVector1DComplex(complex, vSpace as unknown as ComplexWeight)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as Complex, complexW)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            const vSpace1 = new ProjectiveComplexVectorSpace(dimension);
            expect(() =>  new ProjectiveVector1DComplex(vSpace1 as unknown as Complex, complexW)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as Complex, complexW)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, complex as unknown as ComplexWeight)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(-1 as unknown as Complex, complexW)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, 3 as unknown as ComplexWeight)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(weightR as unknown as Complex, complexW)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, weightI as unknown as ComplexWeight)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a projective complex vector into a user-defined vector space if the user-specified coordinates are not a complex and a complex weight`, () => {
            ...
            const weightR = new Weight(2);
            const weightI = new Weight(4);
            expect(() =>  new ProjectiveVector1DComplex(complex, vSpace as unknown as ComplexWeight, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as Complex, complexW, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(complex, vSpace as unknown as ComplexWeight, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as Complex, complexW, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new ProjectiveVector1DComplex(vSpace1 as unknown as Complex, complexW, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(vSpace1 as unknown as Complex, complexW, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as Complex, complexW, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, complex as unknown as ComplexWeight, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as Complex, complexW, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, complex as unknown as ComplexWeight, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(-1 as unknown as Complex, complexW, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, 3 as unknown as ComplexWeight, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(-1 as unknown as Complex, complexW, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, 3 as unknown as ComplexWeight, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(weightR as unknown as Complex, complexW, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, weightI as unknown as ComplexWeight, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(weightR as unknown as Complex, complexW, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, weightI as unknown as ComplexWeight, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(complex, vSpace1 as unknown as ComplexWeight, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complex, vSpace1 as unknown as ComplexWeight, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new ProjectiveVector1DComplex(complex, complexW, weightR as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a projective complex vector into a default vector space with a default complex weight if the user-specified coordinate is not a complex only`, () => {
            ...
            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as Complex)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(-1 as unknown as Complex)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(weight as unknown as Complex)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a projective complex vector into a user-specified vector space with a default complex weight if the user-specified coordinate is not a complex only`, () => {
            ...
            const weight = new Weight(2);
            const vSpace1 = new ProjectiveComplexVectorSpace(dimension);
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as Complex, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as Complex, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(vSpace1 as unknown as Complex, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
       
            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as Complex, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as Complex, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(-1 as unknown as Complex, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(-1 as unknown as Complex, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(weight as unknown as Complex, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(weight as unknown as Complex, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a projective complex vector into a default vector space if the user-specified coordinates are not a real and imaginary parts and the weight is not real and imaginary weights`, () => {
            ...
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as number, 1, weightR, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace as unknown as number, weightR, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new ProjectiveVector1DComplex(complex as unknown as number, 1, weightR, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, complex as unknown as number, weightR, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as number, 1, weightR, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, complexW as unknown as number, weightR, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(vSpace1 as unknown as number, 1, weightR, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace1 as unknown as number, weightR, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(0, 1, 2 as unknown as Weight, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, 1, weightR, 3 as unknown as Weight)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new ProjectiveVector1DComplex(0, 1, complex as unknown as Weight, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, 1, weightR, complex as unknown as Weight)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(0, 1, complexW as unknown as Weight, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, 1, weightR, complexW as unknown as Weight)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(0, 1, vSpace1 as unknown as Weight, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, 1, weightR, vSpace1 as unknown as Weight )).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new ProjectiveVector1DComplex(complex as unknown as number, complexW as unknown as number, vSpace1 as unknown as Weight, weightI)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a projective complex vector into a user-defined vector space if the user-specified coordinates are not a real and imaginary parts and the weight is not real and imaginary weights`, () => {
            ...
            const complex = new Complex(-1, 3);
            const complexW = new ComplexWeight(new Weight(3), new Weight(2));
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as number, 1, weightR, weightI, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace as unknown as number, weightR, weightI, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as number, 1, weightR, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace as unknown as number, weightR, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(complex as unknown as number, 1, weightR, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, complex as unknown as number, weightR, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as number, 1, weightR, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, complexW as unknown as number, weightR, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(vSpace1 as unknown as number, 1, weightR, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace1 as unknown as number, weightR, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(0, 1, 2 as unknown as Weight, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, 1, weightR, 3 as unknown as Weight, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new ProjectiveVector1DComplex(0, 1, complex as unknown as Weight, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, 1, weightR, complex as unknown as Weight, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(0, 1, complexW as unknown as Weight, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, 1, weightR, complexW as unknown as Weight, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(0, 1, vSpace1 as unknown as Weight, weightI, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, 1, weightR, vSpace1 as unknown as Weight, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        })
        ...
        it(`cannot generate a projective complex vector into a default vector space if the user-specified coordinates are not a real and imaginary parts with a default complex weight`, () => {
            ...
            const complex = new Complex(-1, 3);
            const complexW = new ComplexWeight(new Weight(3), new Weight(2));
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as number, 1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace as unknown as number)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new ProjectiveVector1DComplex(complex as unknown as number, 1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, complex as unknown as number)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as number, 1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, complexW as unknown as number)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(vSpace1 as unknown as number, 1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace1 as unknown as number)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(weight as unknown as number, 1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, weight as unknown as number)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
    ...
    it(`cannot generate a projective complex vector into a user-defined vector space if the user-specified coordinates are not a real and imaginary parts with a default complex weight`, () => {
            ...
            const complex = new Complex(-1, 3);
            const complexW = new ComplexWeight(new Weight(3), new Weight(2));
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as number, 1, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace as unknown as number, vSpace as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as number, 1, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace as unknown as number, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new ProjectiveVector1DComplex(complex as unknown as number, 1, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, complex as unknown as number, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(complexW as unknown as number, 1, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, complexW as unknown as number, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(vSpace1 as unknown as number, 1, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, vSpace1 as unknown as number, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector1DComplex(weight as unknown as number, 1, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector1DComplex(0, weight as unknown as number, vSpace1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new ProjectiveVector1DComplex(0, 1, complexW as unknown as ProjectiveComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`can generate a user-defined complex projective vector into a user-defined vector space even if the vector space is type casted into a ComplexWeight`, () => {
            ...
            expect(() =>  new ProjectiveVector1DComplex(complex, vSpace as unknown as ComplexWeight)).to.not.throw();
            const vector = new ProjectiveVector1DComplex(complex, vSpace as unknown as ComplexWeight);
        ...
        it(`can generate a default complex projective vector into a user-defined vector space even if the vector space is type casted into a Complex`, () => {
            ...
            const defaultComplexWeight = new ComplexWeight();
            const defComplxWeightValues = new Complex(defaultComplexWeight.real.value, defaultComplexWeight.imaginary.value);
            expect(() =>  new ProjectiveVector1DComplex(vSpace as unknown as Complex)).to.not.throw();
            const vector = new ProjectiveVector1DComplex(vSpace as unknown as Complex);
            expect(vector.vectorSpace).to.eql(vSpace);
            expect(vector.vectorSpace.isDefault).to.eql(false);
        ...
        it(`can generate a user-defined complex projective vector into a user-defined vector space even if the vector space is type casted into real and imaginary coordinates`, () => {
            ...
            expect(() =>  new ProjectiveVector1DComplex(complex as unknown as number, vSpace as unknown as number)).to.not.throw();
            const vector = new ProjectiveVector1DComplex(complex as unknown as number, vSpace as unknown as number);
            expect(vector.vectorSpace).to.eql(vSpace);
            expect(vector.vectorSpace.isDefault).to.eql(false);
            expect(vector.getCoordinate(0)).to.eql(complex);
    ...
    describe('Accessors', () => {
        it(`can get the vector type of a vector`, () => {
            const vSpace = new ProjectiveComplexVectorSpace(dimension);
            const projectiveComplexVector = new ProjectiveVector1DComplex(1, 2, vSpace);
            expect(projectiveComplexVector.vectorType).to.eql(PROJECTIVECOMPLEXVECTOR1D);
        });
        ...
        it(`can get the coordinates of a vector as an array of complex numbers`, () => {
            ...
            const projectiveComplexVector = new ProjectiveVector1DComplex(complex, complexW, vSpace);
    ...
    describe('Methods', () => {
        ...
        it(`can get the vector descriptor as a string`, () => {
            ...
            const vSpace1 = new ProjectiveComplexVectorSpace(dimension);
            const projectiveComplexVector = new ProjectiveVector1DComplex(coordinates, complexW, vSpace1);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
            expect(projectiveComplexVector.vectorType).to.eql(PROJECTIVECOMPLEXVECTOR1D);
            expect(projectiveComplexVector.spaceType).to.eql(VectorSpaceType.PROJECTIVECOMPLEX);
            expect(projectiveComplexVector.vectorSpace.isDefault).to.eql(false);
        ...
        it(`can clone a vector living into a default vector space`, () => {
            ...
            const complexW = new ComplexWeight(realW, imaginaryW);
            const coordinates = [complex, new Complex(realW.value, imaginaryW.value)];
            const projectiveComplexVector = new ProjectiveVector1DComplex(complex, complexW);
            expect(projectiveComplexVector.dimension).to.eql(dimension);
            expect(projectiveComplexVector.spaceType).to.eql(VectorSpaceType.PROJECTIVECOMPLEX);
            expect(projectiveComplexVector.vectorSpace.isDefault).to.eql(true);
            expect(projectiveComplexVector.vectorSpace.weightManagement).to.eql(WeightManagement.AllStrictlyPositiveWeights);
        ...
        it(`can add a vector with another complex projective vector in the same default vector space with ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
            ...
            const projectiveComplexVector1 = new ProjectiveVector1DComplex(complex, complexW);
            ...
            const projectiveComplexVector2 = new ProjectiveVector1DComplex(complex2, complexW1, vectorSpace);
        ...
        it(`can add a vector with another complex projective vector in the same user-defined vector space with ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
            ...
            const complexW = new ComplexWeight(realW, imaginaryW);
            const coordinates1 = [complex, new Complex(realW.value, imaginaryW.value)]
            const projectiveComplexVector1 = new ProjectiveVector1DComplex(complex, complexW, vSpace);
            expect(projectiveComplexVector1.dimension).to.eql(dimension);
            expect(projectiveComplexVector1.spaceType).to.eql(VectorSpaceType.PROJECTIVECOMPLEX);
        ...
        it(`cannot add complex projective vectors with different weight statuses under ${WeightManagement.AllPositiveWeights} weight management and get a resulting vector with complex weight status strictly positive: false`, () => {
            ...
            const imaginaryW1 = new Weight(3);
            const complexW1 = new ComplexWeight(realW1, imaginaryW1);
            expect(() => new ProjectiveVector1DComplex(complex2, complexW1, vectorSpace)).to.throw(EM_STRICTLYPOS_STATUS_INCOMPATIBLE_WEIGHT_MANAGEMENT);
        });
        ...
        it(`cannot add a vector with another vector of same dimension but belonging to another vector space`, () => {
            ...
            const projectiveComplexVector2 = new ProjectiveVector1DComplex(complex2, complexW1, vSpace2);
            expect(projectiveComplexVector2.vectorSpace.weightManagement).to.eql(WeightManagement.AllPositiveWeights);
        ...
        it(`cannot check the equality of vectors belonging to different vector spaces of same type `, () => {
            ...
            expect(projectiveComplexVector1.spaceType).to.eql(VectorSpaceType.PROJECTIVECOMPLEX);
            expect(projectiveComplexVector1.vectorSpace.isDefault).to.eql(false);
            const projectiveComplexVector2 = new ProjectiveVector1DComplex(complex, complexW);
        ...
        it(`can check the vector dimension against the vector space dimension`, () => {
            class CustomProjectiveComplexVector extends ProjectiveVector1DComplex {
