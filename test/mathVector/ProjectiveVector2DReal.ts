...
describe('Projective vector 2D in real vector space: generation and operators in this vector space', () => {
    ...
    describe('Constructor', () => {
        it(`can generate a default projective real vector into the default 3D projective vector space`, () => {
            const projRealVector = new ProjectiveVector2DReal();
        ...
        it(`can generate an arbitrary projective real vector with default weight into the default 3D projective vector space`, () => {
            const x = -1;
            const y = 2;
            const projRealVector = new ProjectiveVector2DReal(x, y);
            expect(projRealVector.coordinates.length).to.eql(dimension);
        ...
        it(`can generate an arbitrary projective real vector with prescribed weight into the default 3D vector space`, () => {
            ...
            const projRealVector = new ProjectiveVector2DReal(-1, 2, weight);
            expect(projRealVector.coordinates.length).to.eql(dimension);
        ...
        it(`can generate a default projective real vector with a default weight into a user-defined 3D vector space`, () => {
            ...
            const projRealVector = new ProjectiveVector2DReal(vSpace);
            expect(projRealVector.coordinates.length).to.eql(dimension);
            expect(projRealVector.coordinates).to.eql([0, 0, 1]);
            expect(projRealVector.dimension).to.eql(dimension);
            expect(projRealVector.getCoordinate(0)).to.eql(0);
        ...
        it(`can generate an arbitrary projective real vector with default weight into a user-defined 3D vector space`, () => {
            const vSpace = new ProjectiveRealVectorSpace(dimension);
            const projRealVector = new ProjectiveVector2DReal(1, -2, vSpace);
            expect(projRealVector.coordinates.length).to.eql(dimension);
        ...
        it(`can generate an arbitrary projective real vector with default weight into a user-defined 3D vector space with weight management ${WeightManagement.AllPositiveWeights}`, () => {
            ...
            const projRealVector = new ProjectiveVector2DReal(x, y, vSpace);
            expect(projRealVector.coordinates.length).to.eql(dimension);
            expect(projRealVector.coordinates).to.eql([x, y, DEFAULT_WEIGHT_VALUE]);
            expect(projRealVector.dimension).to.eql(dimension);
            expect(projRealVector.getCoordinate(0)).to.eql(x);
        ...
        it(`can generate an arbitrary projective real vector with prescribed weight into a user-defined 3D vector space`, () => {
            const weight = new Weight(2);
            const vSpace = new ProjectiveRealVectorSpace(dimension);
            const projRealVector = new ProjectiveVector2DReal(1, -2, weight, vSpace);
            expect(projRealVector.coordinates.length).to.eql(dimension);
        ...
        it(`can generate a default projective real vector with prescribed weight management ${WeightManagement.AllPositiveWeights} and null weight`, () => {
            ...
            const projRealVector = new ProjectiveVector2DReal(1, 2, new Weight(0, false), vSpace);
            expect(projRealVector.vectorSpace.isDefault).to.eql(true);
            let weightMgmt = projRealVector.vectorSpace.weightManagement;
            expect(weightMgmt).to.eql(WeightManagement.AllPositiveWeights);
            expect(projRealVector.coordinates.length).to.eql(dimension);
        ...
        it(`can generate user-defined projective real vectors with prescribed weight management ${WeightManagement.SomeNullWeights} and null or strictly positive weights`, () => {
            ...
            const projRealVector1 = new ProjectiveVector2DReal(0, -2, vSpace);
            ...
            const projRealVector2 = new ProjectiveVector2DReal(0, -2, new Weight(2, false), vSpace);
        ...
        it(`cannot set a null weight, or a weight that can become null, to a vector with weight management ${WeightManagement.AllStrictlyPositiveWeights} and default 3D projective real vector space`, () => {
            ...
            expect(vSpace.isDefault).to.eql(true);
            expect(() =>  new ProjectiveVector2DReal(1, 1, new Weight(0, false), vSpace)).to.throw(EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(1, 1, new Weight(2, false), vSpace)).to.throw(EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
        });

        it(`cannot set a null weight, or a weight that can become null, to a vector with weight management ${WeightManagement.AllStrictlyPositiveWeights} and default 3D projective real vector space`, () => {
            expect(() =>  new ProjectiveVector2DReal(1, 1, new Weight(0, false))).to.throw(EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(1, 1, new Weight(2, false))).to.throw(EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
        });
        ...
        it(`cannot set a strictly positive weight to a vector with weight management ${WeightManagement.AllPositiveWeights} and default 3D projective real vector space`, () => {
            const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllPositiveWeights, true);
            expect(vSpace.isDefault).to.eql(true);
            expect(() =>  new ProjectiveVector2DReal(1, 2, new Weight(3, true), vSpace)).to.throw(EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
        });
        ...
        it(`can generate a vector with weight management ${WeightManagement.AllStrictlyPositiveWeights} and a weight value smaller than ${NULL_WEIGHT_TOLERANCE}`, () => {
            ...
            const projRealVector = new ProjectiveVector2DReal(1, 2, smallWeight);
            expect(projRealVector.vectorSpace.isDefault).to.eql(true);
            let weightMgmt = projRealVector.vectorSpace.weightManagement;
        ...
        it(`can generate a vector with weight management ${WeightManagement.AllPositiveWeights} and an input weight value smaller than ${NULL_WEIGHT_TOLERANCE}`, () => {
            ...
            const projRealVector = new ProjectiveVector2DReal(1, 2, smallWeight, vectorSpace);
            expect(projRealVector.vectorSpace.isDefault).to.eql(true);
            let weightMgmt = projRealVector.vectorSpace.weightManagement;
            expect(weightMgmt).to.eql(WeightManagement.AllPositiveWeights);
            expect(projRealVector.coordinates.length).to.eql(dimension);
        ...
        it(`can generate a vector with weight management ${WeightManagement.SomeNullWeights} and an input weight value smaller than ${NULL_WEIGHT_TOLERANCE}`, () => {
            ...
            const projRealVector1 = new ProjectiveVector2DReal(1, 2, smallWeight1, vectorSpace);
        ...
        it(`cannot generate a projective vector into a default vector space  with a default weight if the user-specified coordinates are not numbers`, () => {
            ...
            expect(() =>  new ProjectiveVector2DReal(2, new Weight() as unknown as number)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(new Weight() as unknown as number, 0)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a projective vector into a user-defined vector space if the user-specified coordinates are not numbers and/or the vector space is not of type projective real and of same dimension as the vector`, () => {
            // Use type casting as allowed by typescript even though they describe configurations that should be avoided
            const vSpace = new ProjectiveRealVectorSpace(4);
            expect(() =>  new ProjectiveVector2DReal(0, -2, vSpace as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
            const vSpace1 = new RealVectorSpace(3);
            expect(() =>  new ProjectiveVector2DReal(0, -2, vSpace1 as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(vSpace as unknown as number, -2, vSpace1 as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(0, vSpace as unknown as number, vSpace1 as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector2DReal(0, new Weight() as unknown as number, vSpace1 as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(new Weight() as unknown as number, -3, vSpace1 as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            const vSpace2 = new ProjectiveRealVectorSpace(dimension);
            expect(() =>  new ProjectiveVector2DReal(vSpace as unknown as number, -2, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(0, vSpace as unknown as number, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector2DReal(1, new Weight() as unknown as number, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(new Weight() as unknown as number, 4, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a projective vector into a default vector space if the user-specified coordinates are not numbers and a weight`, () => {
            // Use type casting as allowed by typescript even though they describe configurations that should be avoided
            const vSpace = new ProjectiveRealVectorSpace(4);
            expect(() =>  new ProjectiveVector2DReal(0, -2, vSpace as unknown as Weight)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
            const vSpace1 = new RealVectorSpace(3);
            expect(() =>  new ProjectiveVector2DReal(0, -2, vSpace1 as unknown as Weight)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(vSpace as unknown as number, -2, new Weight())).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(0, vSpace as unknown as number, new Weight())).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector2DReal(0, new Weight() as unknown as number, new Weight())).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(new Weight() as unknown as number, -3, new Weight())).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            const vSpace2 = new ProjectiveRealVectorSpace(dimension);
            expect(() =>  new ProjectiveVector2DReal(vSpace2 as unknown as number, -2, new Weight())).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(0, vSpace2 as unknown as number, new Weight())).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector2DReal(1, new Weight() as unknown as number, -3 as unknown as Weight)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(new Weight() as unknown as number, 4, 2 as unknown as Weight)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a projective vector into a user-defined vector space if the user-specified coordinates are not numbers and a weight`, () => {
            // Use type casting as allowed by typescript even though they describe configurations that should be avoided
            const vSpace = new ProjectiveRealVectorSpace(4);
            expect(() =>  new ProjectiveVector2DReal(0, -2, new Weight(2), vSpace as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
            const vSpace1 = new RealVectorSpace(3);
            expect(() =>  new ProjectiveVector2DReal(0, -2, new Weight(2), vSpace1 as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(vSpace as unknown as number, -2, new Weight(), vSpace1 as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(0, vSpace as unknown as number, new Weight(), vSpace1 as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(0, -3, vSpace as unknown as Weight, vSpace1 as unknown as ProjectiveRealVectorSpace<3>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector2DReal(0, new Weight() as unknown as number, new Weight())).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(new Weight() as unknown as number, -3, new Weight())).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            const vSpace2 = new ProjectiveRealVectorSpace(dimension);
            expect(() =>  new ProjectiveVector2DReal(vSpace2 as unknown as number, -2, new Weight(), vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(0, vSpace2 as unknown as number, new Weight(), vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(0, -2, vSpace2 as unknown as Weight, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector2DReal(1, new Weight() as unknown as number, -3 as unknown as Weight, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new ProjectiveVector2DReal(new Weight() as unknown as number, 4, 2 as unknown as Weight, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a projective vector into a default vector space with user-specified coordinates and a prescribed weight of incorrect type`, () => {
            ...
            const y = 6;
            const vSpace = new ProjectiveRealVectorSpace(4);
            expect(() =>  new ProjectiveVector2DReal(x, y, vSpace as unknown as Weight)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
            const vSpace1 = new RealVectorSpace(3);
            expect(() =>  new ProjectiveVector2DReal(x, y, vSpace1 as unknown as Weight)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);

            expect(() =>  new ProjectiveVector2DReal(x, y, x as unknown as Weight)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
        });
        ...
        it(`can generate a user-defined projective vector into a user-defined vector space even if the vector space is type casted into a Weight`, () => {
            // Use type casting as allowed by typescript even though they describe configurations that should be avoided
            const vSpace = new ProjectiveRealVectorSpace(dimension);
            expect(() =>  new ProjectiveVector2DReal(1, 3, vSpace as unknown as Weight)).to.not.throw();
            const vector = new ProjectiveVector2DReal(1, 3, vSpace as unknown as Weight);
        ...
        it(`can generate a user-defined projective vector into a default vector space even if the weight is type casted into a projective vector space`, () => {
            // Use type casting as allowed by typescript even though they describe configurations that should be avoided
            expect(() =>  new ProjectiveVector2DReal(1, 3, new Weight(3) as unknown as ProjectiveRealVectorSpace<3>)).to.not.throw();
            const vector = new ProjectiveVector2DReal(1, 3, new Weight(3) as unknown as ProjectiveRealVectorSpace<3>);
    ...
    describe('Accessors', () => {
        ...
        it(`can get the coordinates of a vector as x, y parameters`, () => {
            const projRealVector = new ProjectiveVector2DReal(1, 2);
        ...
        it(`can get the weight of a vector as w parameter of a vector into a default vector space with weight management ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
            ...
            const weight1 = 3;
            const projRealVector1 = new ProjectiveVector2DReal(1, 2, new Weight(weight1));
        ...
        it(`can get the weight as w parameter of a vector into a default vector space with weight management ${WeightManagement.AllPositiveWeights}`, () => {
            const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllPositiveWeights);
            const weight = 0;
            const projRealVector = new ProjectiveVector2DReal(1, 2, new Weight(weight, false), vSpace);
            expect(projRealVector.w).to.eql(weight);
            expect(projRealVector.dimension).to.eql(dimension);
            expect(projRealVector.vectorType).to.eql(PROJECTIVEREALVECTOR2D);
            expect(projRealVector.spaceType).to.eql(VectorSpaceType.PROJECTIVEREAL);
        ...
        it(`can get the weight as w parameter of a vector into a default vector space with weight management ${WeightManagement.SomeNullWeights}`, () => {
            ...
            const weight1 = 3;
            const projRealVector1 = new ProjectiveVector2DReal(1, 2, new Weight(weight1, true), vSpace);
            expect(projRealVector1.w).to.eql(weight1);
            expect(projRealVector1.dimension).to.eql(dimension);
            expect(projRealVector1.vectorType).to.eql(PROJECTIVEREALVECTOR2D);
    ...
    describe('Methods', () => {
        ...
        it(`can get the vector descriptor as a string`, () => {
            ...
            const projectiveVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], vSpace1);
            expect(projectiveVector1.dimension).to.eql(dimension);
            expect(projectiveVector1.vectorType).to.eql(PROJECTIVEREALVECTOR2D);
            ...
            expect(string).to.eql(PROJECTIVEREALVECTOR2D + `(${coordinates[0]}, ${coordinates[1]}, ${new Weight().toString()})` + ` `+ projectiveVector1.vectorSpace.toString());
        });
        ...
        it(`cannot get a null norm with weight management ${WeightManagement.AllStrictlyPositiveWeights} because a null projective vector cannot be created`, () => {
            ...
            const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllStrictlyPositiveWeights);
            expect(() =>  new ProjectiveVector2DReal(coordinates[0], coordinates[1], new Weight(0, false), vSpace)).to.throw(EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
        });

        it(`can get a null norm with weight management ${WeightManagement.AllPositiveWeights}`, () => {
            const coordinates = [0, 0];
            const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllPositiveWeights);
            const projectiveVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], new Weight(0, false), vSpace);
            expect(projectiveVector1.dimension).to.eql(dimension);
            expect(projectiveVector1.vectorType).to.eql(PROJECTIVEREALVECTOR2D);
            expect(projectiveVector1.spaceType).to.eql(VectorSpaceType.PROJECTIVEREAL);
            expect(projectiveVector1.vectorSpace.isDefault).to.eql(false);
        ...
        it(`cannot normalize a vector with a norm smaller than ${NULL_WEIGHT_TOLERANCE} and weight management ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
            const coordinates = [0, 0];
            const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllStrictlyPositiveWeights);
            const projectiveVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], new Weight(NULL_WEIGHT_TOLERANCE / 2), vSpace);
            expect(projectiveVector1.dimension).to.eql(dimension);
            expect(projectiveVector1.vectorType).to.eql(PROJECTIVEREALVECTOR2D);
            expect(projectiveVector1.spaceType).to.eql(VectorSpaceType.PROJECTIVEREAL);
            expect(projectiveVector1.vectorSpace.isDefault).to.eql(false);
        ...
        it(`cannot normalize a vector with a norm smaller than ${NULL_WEIGHT_TOLERANCE} and weight management ${WeightManagement.AllPositiveWeights}`, () => {
            const coordinates = [0, 0];
            const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllPositiveWeights);
            const projectiveVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], new Weight(NULL_WEIGHT_TOLERANCE / 2, false), vSpace);
            expect(projectiveVector1.dimension).to.eql(dimension);
            expect(projectiveVector1.vectorType).to.eql(PROJECTIVEREALVECTOR2D);
            expect(projectiveVector1.spaceType).to.eql(VectorSpaceType.PROJECTIVEREAL);
            expect(projectiveVector1.vectorSpace.isDefault).to.eql(false);
        ...
        it(`can apply the homogeneous transform to a projective vector to set a weight with default value ${DEFAULT_WEIGHT_VALUE} with a weight management ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
            ...
            const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllStrictlyPositiveWeights);
            const projRealVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], new Weight(coordinates[dimension - 1]), vSpace);
            expect(projRealVector1.dimension).to.eql(dimension);
            expect(projRealVector1.vectorSpace.isDefault).to.eql(false);
        ...
        it(`can apply the homogeneous transform to a projective vector into a default vector space to set a weight with default value ${DEFAULT_WEIGHT_VALUE} with a weight management ${WeightManagement.AllPositiveWeights}`, () => {
            const coordinates = [2, 4, 6];
            const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllPositiveWeights, true);
            const projRealVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], new Weight(coordinates[dimension - 1], false), vSpace);
            expect(projRealVector1.dimension).to.eql(dimension);
        ...
        it(`can map a projective vector with null weight into a vector of a user-defined real vector space`, () => {
            ...
            const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllPositiveWeights);
            const projRealVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], new Weight(0, false), vSpace);
            expect(projRealVector1.dimension).to.eql(dimension);
            expect(projRealVector1.vectorSpace.isDefault).to.eql(false);
            expect(projRealVector1.vectorSpace.weightManagement).to.eql(WeightManagement.AllPositiveWeights);
            const realVSpace = new RealVectorSpace(2);
        ...
        describe('Methods with binary operators whose unit tests cannot be factorized', () => {
            ...
            it(`can add a vector with another projective vector in the same default vector space with ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
                ...
                const projRealVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], new Weight(coordinates[dimension - 1]),
                ...
                const projRealVector2 = new ProjectiveVector2DReal(defaultCoordinates[0], defaultCoordinates[1], new Weight(defaultCoordinates[dimension - 1]), vectorSpace);
            ...
            it(`can add a vector with another projective vector in the same user-defined vector space with ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
                ...
                expect(projRealVector1.vectorSpace.isDefault).to.eql(false);
                expect(projRealVector1.vectorSpace.weightManagement).to.eql(WeightManagement.AllStrictlyPositiveWeights);
                const projRealVector2 = new ProjectiveVector2DReal(defaultCoordinates[0], defaultCoordinates[1], new Weight(defaultCoordinates[dimension - 1]), vSpace);
                const result = projRealVector1.add(projRealVector2);
                for (let i = 0; i < dimension - 1; i++) {
                    expect(result.getCoordinate(i)).to.eql(coordinates[i] + defaultCoordinates[i]);
                }
            ...
            it(`can add a vector with another projective vector in the same default vector space with ${WeightManagement.SomeNullWeights}`, () => {
                const coordinates = [1, -3, 5];
                const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.SomeNullWeights, true);
                const projRealVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], defaultWeight, vSpace);
                expect(projRealVector1.dimension).to.eql(dimension);
                expect(projRealVector1.spaceType).to.eql(VectorSpaceType.PROJECTIVEREAL);
                expect(projRealVector1.vectorSpace.isDefault).to.eql(true);
                expect(projRealVector1.vectorSpace.weightManagement).to.eql(WeightManagement.SomeNullWeights);
                expect(projRealVector1.weight).to.eql(defaultWeight);
                const projRealVector2 = new ProjectiveVector2DReal(defaultCoordinates[0], defaultCoordinates[1], new Weight(0,false), vSpace);
            ...
            it(`can add a vector with another projective vector in the same default vector space with ${WeightManagement.AllPositiveWeights}`, () => {
                const coordinates = [1, -3, 5];
                const vSpace = new ProjectiveRealVectorSpace(dimension, WeightManagement.AllPositiveWeights, true);
                const projRealVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], defaultPositiveWeight, vSpace);
                expect(projRealVector1.dimension).to.eql(dimension);
                expect(projRealVector1.spaceType).to.eql(VectorSpaceType.PROJECTIVEREAL);
                expect(projRealVector1.vectorSpace.isDefault).to.eql(true);
                expect(projRealVector1.vectorSpace.weightManagement).to.eql(WeightManagement.AllPositiveWeights);
            ...
            it(`can add a vector with another projective vector with weight smaller than ${NULL_WEIGHT_TOLERANCE} in the same default vector space with ${WeightManagement.AllStrictlyPositiveWeights} without influence of NULL_WEIGHT_TOLERANCE`, () => {
                ...
                const projRealVector2 = new ProjectiveVector2DReal(defaultCoordinates[0], defaultCoordinates[1], smallWeight, vSpace);
                expect(projRealVector2.vectorSpace.isDefault).to.eql(true);
            ...
            it(`cannot add vectors with different weight statuses under ${WeightManagement.AllPositiveWeights} weight management and get a resulting vector with weight status strictly positive: false`, () => {
                ...
                expect(projRealVector1.vectorSpace.weightManagement).to.eql(WeightManagement.AllPositiveWeights);
                expect(projRealVector1.weight).to.eql(new Weight(DEFAULT_WEIGHT_VALUE, false));
                expect(() => new ProjectiveVector2DReal(defaultCoordinates[0], defaultCoordinates[1], smallWeight, vSpace)).to.throw(EM_PROJECTIVE_VECTOR_WEIGHT_STATUS_INCOMPATIBLE);
            });

            it(`cannot add a vector with another vector of same dimension but belonging to another vector space`, () => {
                const coordinates = [1, 3, 5];
                const projRealVector1 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], defaultWeight, undefined);
                expect(projRealVector1.dimension).to.eql(dimension);
                expect(projRealVector1.spaceType).to.eql(VectorSpaceType.PROJECTIVEREAL);
                expect(projRealVector1.vectorSpace.isDefault).to.eql(true);
                const vSpace = new ProjectiveRealVectorSpace(dimension);
                const projRealVector2 = new ProjectiveVector2DReal(defaultCoordinates[0], defaultCoordinates[1], defaultWeight, vSpace);
            ...
            it(`can subtract a vector from another projective vector of same dimension in the same default vector space with weight management ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
                ...
                const projRealVector2 = new ProjectiveVector2DReal(coordinates2[0], coordinates2[1], new Weight(coordinates2[dimension - 1]));
                expect(projRealVector2.vectorSpace.weightManagement).to.eql(WeightManagement.AllStrictlyPositiveWeights);
            ...
            it(`can subtract a vector from another projective vector of same dimension belonging to the same user-defined vector space with weight management ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
                ...
                expect(projRealVector1.vectorSpace.weightManagement).to.eql(WeightManagement.AllStrictlyPositiveWeights);
                const coordinates2 = [1, 3, 5];
                const projRealVector2 = new ProjectiveVector2DReal(coordinates2[0], coordinates2[1], new Weight(coordinates2[dimension - 1]), vSpace);
                const result = projRealVector1.subtract(projRealVector2);
                const resultCoordinates = coordinates.map((c, i) => c - coordinates2[i]);
                expect(result.coordinates).to.eql(resultCoordinates.slice(0, dimension));
            ...
            it(`can subtract a vector from another projective vector of same dimension in the same default vector space with weight management ${WeightManagement.AllPositiveWeights}`, () => {
                ...
                expect(projRealVector1.vectorSpace.weightManagement).to.eql(WeightManagement.AllPositiveWeights);
                const coordinates2 = [1, 3, 5];
                const projRealVector2 = new ProjectiveVector2DReal(coordinates2[0], coordinates2[1], new Weight(coordinates2[dimension - 1], false), vSpace);
                expect(projRealVector2.vectorSpace.weightManagement).to.eql(WeightManagement.AllPositiveWeights);
                const result = projRealVector1.subtract(projRealVector2);
                const resultCoordinates = coordinates.map((c, i) => c - coordinates2[i]);
                expect(result.coordinates).to.eql(resultCoordinates.slice(0, dimension));
            ...
            it(`cannot check the parallelism of vectors belonging to different vector spaces`, () => {
                ...
                expect(projRealVector1.spaceType).to.eql(VectorSpaceType.PROJECTIVEREAL);
                expect(projRealVector1.vectorSpace.isDefault).to.eql(false);
                const projRealVector2 = new ProjectiveVector2DReal(coordinates[0], coordinates[1], new Weight(coordinates[dimension - 1]));
            ...
            it(`can check the parallelism of a vector with another projective vector in the same default vector space with ${WeightManagement.AllStrictlyPositiveWeights}`, () => {
                ...
                const projRealVector2 = new ProjectiveVector2DReal(coordinates2[0], coordinates2[1], new Weight(coordinates2[dimension - 1]), vectorSpace);
            ...
            it(`can check the parallelism of a vector with another projective vector in the same custom vector space with ${WeightManagement.AllPositiveWeights}`, () => {
                ...
                const projRealVector2 = new ProjectiveVector2DReal(coordinates2[0], coordinates2[1], new Weight(coordinates2[dimension - 1], false), vectorSpace);
                expect(projRealVector1.isParallel(projRealVector2)).to.eql(true);
            });
