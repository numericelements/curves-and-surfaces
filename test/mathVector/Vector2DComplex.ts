...
describe('Vector 2D in complex vector space: generation and operators in this vector space', () => {
    ...
    describe('Constructor', () => {
        it(`can generate a default complex vector into the default 2D vector space`, () => {
            const complexVector = new Vector2DComplex();
        ...
        it(`can generate an arbitrary complex vector into the default 2D vector space using real and imaginary values`, () => {
            const complexVector = new Vector2DComplex(-1, 2, 3, -4);
        ...
        it(`can generate an arbitrary complex vector into the default 2D vector space using complex numbers`, () => {
            const complex1 = new Complex(-1, 2);
            const complex2 = new Complex(3, -4);
            const complexVector = new Vector2DComplex(complex1, complex2);
            expect(complexVector.coordinates).to.eql([complex1, complex2]);
            expect(complexVector.dimension).to.eql(dimension);
            expect(complexVector.getCoordinate(0)).to.eql(complex1);
            expect(complexVector.getCoordinate(1)).to.eql(complex2);
        ...
        it(`can generate a default complex vector into a 2D vector space`, () => {
            ...
            const complexVector = new Vector2DComplex(vSpace);
            expect(complexVector.coordinates).to.eql([new Complex(), new Complex()]);
            expect(complexVector.dimension).to.eql(dimension);
            expect(complexVector.getCoordinate(0)).to.eql(new Complex());
            expect(complexVector.getCoordinate(0)).to.eql(new Complex());
        ...
        it(`can generate an arbitrary complex vector into a 2D vector space using real and imaginary values`, () => {
            ...
            const complexVector = new Vector2DComplex(real, imaginary, real1, imaginary1, vSpace);
            expect(complexVector.coordinates).to.eql([complex1, complex2]);
            expect(complexVector.dimension).to.eql(dimension);
            expect(complexVector.getCoordinate(0)).to.eql(complex1);
            expect(complexVector.getCoordinate(1)).to.eql(complex2);
        ...
        it(`can generate an arbitrary complex vector into a 2D vector space using real and imaginary values into a default vector space`, () => {
            ...
            const complex1 = new Complex(real, imaginary);
            const complex2 = new Complex(real1, imaginary1);
            const complexVector = new Vector2DComplex(real, imaginary, real1, imaginary1);
            expect(complexVector.coordinates).to.eql([complex1, complex2]);
            expect(complexVector.dimension).to.eql(dimension);
            expect(complexVector.getCoordinate(0)).to.eql(complex1);
            expect(complexVector.getCoordinate(1)).to.eql(complex2);
        ...
        it(`can generate an arbitrary complex vector into a 2D vector space using complex numbers`, () => {
            ...
            const complex1 = new Complex(real, imaginary);
            const complex2 = new Complex(real1, imaginary1);
            const complexVector = new Vector2DComplex(complex1, complex2, vSpace);
            expect(complexVector.coordinates).to.eql([complex1, complex2]);
            expect(complexVector.dimension).to.eql(dimension);
            expect(complexVector.getCoordinate(0)).to.eql(complex1);
            expect(complexVector.getCoordinate(1)).to.eql(complex2);
        ...
        it(`cannot generate a default complex vector into a user-defined vector space if this vector space is not of type complex and of same dimension as the vector`, () => {
            ...
            expect(() =>  new Vector2DComplex(vSpace as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            const vSpace1 = new RealVectorSpace(3);
            expect(() =>  new Vector2DComplex(vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });

        it(`cannot generate a complex vector into a default vector space if the user-specified coordinates are not numbers`, () => {
            // Use type casting as allowed by typescript even though they describe configurations that should be avoided
            const vSpace = new ComplexVectorSpace(dimension);
            expect(() =>  new Vector2DComplex(0, 1, -2, vSpace as unknown as number)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(1, 2, vSpace as unknown as number, 1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, vSpace as unknown as number, 3, 2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(vSpace as unknown as number, 1, -1, -3)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new Vector2DComplex(0, 1, -2, new Complex() as unknown as number)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(1, 2, new Complex() as unknown as number, 1)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, new Complex() as unknown as number, 3, 2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(new Complex() as unknown as number, 1, -1, -3)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a real vector into a user-specified vector space if the user-specified coordinates are not numbers and/or the vector space is not of type complex and of same dimension as the vector`, () => {
            // Use type casting as allowed by typescript even though they describe configurations that should be avoided
            const vSpace = new RealVectorSpace(dimension);
            expect(() =>  new Vector2DComplex(0, -2, 1, 4, vSpace as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
            const vSpace1 = new ComplexVectorSpace(1);
            expect(() =>  new Vector2DComplex(0, -2, 1, vSpace as unknown as number, vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, -2, vSpace as unknown as number, -2, vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, vSpace as unknown as number, -2, 3, vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(vSpace as unknown as number, -2, 3, 1, vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            
            expect(() =>  new Vector2DComplex(0, -2, 1, new Complex() as unknown as number, vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, -2, new Complex() as unknown as number, -2, vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, new Complex() as unknown as number, -2, 3, vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(new Complex() as unknown as number, -2, 3, 1, vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            
            const vSpace2 = new ComplexVectorSpace(dimension);
            expect(() =>  new Vector2DComplex(vSpace as unknown as number, -2, 1, 0, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, vSpace as unknown as number, -2, 1, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, 1, vSpace as unknown as number, 0, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, 1, -3, vSpace as unknown as number, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        
            expect(() =>  new Vector2DComplex(new Complex() as unknown as number, -2, 1, 0, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, new Complex() as unknown as number, -2, 1, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, 1, new Complex() as unknown as number, 0, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(0, 1, -3, new Complex() as unknown as number, vSpace2)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a default real vector into a user-defined vector space if this vector space is followed by other parameters`, () => {
            // Use type casting as allowed by typescript even though they describe configurations that should be avoided
            const vSpace = new ComplexVectorSpace(dimension);
            expect(() =>  new Vector2DComplex(vSpace as unknown as Complex, new Complex())).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(vSpace as unknown as number, 1, 2, 3)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
        ...
        it(`cannot generate a complex vector into a default vector space if the user-specified coordinates are not a complex`, () => {
            ...
            expect(() =>  new Vector2DComplex(vSpace as unknown as Complex, new Complex(1, 1))).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(new Complex(1, 1), vSpace as unknown as Complex)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            
            expect(() =>  new Vector2DComplex(0 as unknown as Complex, new Complex(1, -1))).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(new Complex(1, -1), 10 as unknown as Complex)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            
            const vSpace1 = new RealVectorSpace(2);
            expect(() =>  new Vector2DComplex(vSpace1 as unknown as Complex, new Complex(1, 1))).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(new Complex(1, 1), vSpace1 as unknown as Complex)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });

        it(`cannot generate a complex vector into a user-defined vector space if the user-specified coordinates are not a complex`, () => {
            // Use type casting as allowed by typescript even though they describe configurations that should be avoided
            const vSpace = new ComplexVectorSpace(1);
            expect(() =>  new Vector2DComplex(new Complex(1, -1), new Complex(1, 1), 1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(new Complex(1, -1), new Complex(1, 1), vSpace as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(new Complex(1, 1), vSpace as unknown as Complex, vSpace as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(vSpace as unknown as Complex, new Complex(1, 1), vSpace as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);

            expect(() =>  new Vector2DComplex(0 as unknown as Complex, new Complex(1, -1), vSpace as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(new Complex(1, -1), 10 as unknown as Complex, vSpace as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            
            const vSpace1 = new RealVectorSpace(2);
            expect(() =>  new Vector2DComplex(vSpace1 as unknown as Complex, new Complex(1, 1), vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
            expect(() =>  new Vector2DComplex(new Complex(1, 1), vSpace1 as unknown as Complex, vSpace1 as unknown as ComplexVectorSpace<2>)).to.throw(EM_VECTORSPACE_PARAMETERS_INCOMPATIBLE);
        });
    ...
    describe('Methods', () => {
        ...
        it(`can get the real part of a component of a complex vector`, () => {
            const complexVector1 = new Vector2DComplex(complex1, complex2);
        ...
        it(`can get the vector descriptor as a string`, () => {
            ...
            const complexVector1 = new Vector2DComplex(complex1, complex2, vSpace1);
            expect(complexVector1.dimension).to.eql(dimension);
            expect(complexVector1.vectorType).to.eql(COMPLEXVECTOR2D);
            expect(complexVector1.spaceType).to.eql(VectorSpaceType.COMPLEX);
        ...
        it(`cannot normalize a complex vector into a 2D default complex vector space when its norm is smaller than the default tolerance`, () => {
            ...
            const complexVector1 = new Vector2DComplex(smallComplex1, smallComplex2);
            expect(complexVector1.dimension).to.eql(dimension);
            expect(complexVector1.spaceType).to.eql(VectorSpaceType.COMPLEX);
            expect(complexVector1.vectorSpace.isDefault).to.eql(true);
        ...
        it(`can normalize a complex vector into a 2D user-defined complex vector space using the default tolerance`, () => {
            const vSpace = new ComplexVectorSpace(dimension);
            const complexVector1 = new Vector2DComplex(complex1, complex2, vSpace);
            expect(complexVector1.dimension).to.eql(dimension);
            expect(complexVector1.spaceType).to.eql(VectorSpaceType.COMPLEX);
            expect(complexVector1.vectorSpace.isDefault).to.eql(false);
        ...
        it(`cannot check the equality of vectors belonging to different vector spaces `, () => {
            ...
            expect(complexVector1.spaceType).to.eql(VectorSpaceType.COMPLEX);
            expect(complexVector1.vectorSpace.isDefault).to.eql(false);
            const complexVector2 = new Vector2DComplex(complex3, complex4);
        ...
        it(`cannot check the parallelism of vectors because this property is not available for 2D complex vectors`, () => {
            ...
            expect(complexVector1.spaceType).to.eql(VectorSpaceType.COMPLEX);
            expect(complexVector1.vectorSpace.isDefault).to.eql(false);
            const complexVector2 = new Vector2DComplex(complex3, complex4, vSpace);
        ...
        it(`cannot map a complex 2D vector into a projective complex vector`, () => {
            const vSpace = new ComplexVectorSpace(dimension);
            const complexVector = new Vector2DComplex(1, 2, 3, 5, vSpace);
            expect(complexVector.dimension).to.eql(dimension);
            expect(complexVector.vectorType).to.eql(COMPLEXVECTOR2D);
            expect(complexVector.spaceType).to.eql(VectorSpaceType.COMPLEX);
            expect(complexVector.vectorSpace.isDefault).to.eql(false);
        ...
        it(`cannot map a complex 2D vector into a projective complex vector`, () => {
            const vSpace = new ComplexVectorSpace(dimension);
            const complexVector1 = new Vector2DComplex(1, 2, 3, 5, vSpace);
            expect(complexVector1.dimension).to.eql(dimension);
            expect(complexVector1.vectorType).to.eql(COMPLEXVECTOR2D);
            expect(complexVector1.spaceType).to.eql(VectorSpaceType.COMPLEX);
            expect(complexVector1.vectorSpace.isDefault).to.eql(false);
            expect(() => complexVector1.toProjectiveRealVector()).to.throw(EM_VECTORSPACE_DIMENSION_INCOMPATIBLE);
        });
    });
});