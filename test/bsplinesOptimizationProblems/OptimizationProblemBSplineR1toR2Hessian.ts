...
import { OptimizationProblemBSplineR1toR2Hessian} from '../../src/bsplinesOptimizationProblems/OptimizationProblemBSplineR1toR2Hessian'
import { BSplineR1toR2, create_BSplineR1toR2} from '../../src/bsplines/BSplineR1toR2'
...
describe('OptimizationProblemBSplineR1toR2Hessian', () => {
    ...
    it('has a number of independent variables equal to twice the number of control points', () => {
        ...
        let o = new OptimizationProblemBSplineR1toR2Hessian(splineTarget, splineInitial)
    ...
    it('can compute curvature extrema constraint gradient', () => {
        ...
        let o = new OptimizationProblemBSplineR1toR2Hessian(splineTarget, splineInitial, ActiveControl.curvatureExtrema)
        ...
        let o_delta = new OptimizationProblemBSplineR1toR2Hessian(splineTarget_delta, splineInitial_delta, ActiveControl.curvatureExtrema)
