...
import { create_BSplineR1toR2 } from '../../../src/bsplines/R1toR2/BSplineR1toR2';
import { PeriodicBSplineR1toR1 } from '../../../src/bsplines/R1toR1/PeriodicBSplineR1toR1';
...
describe('BSplineR1toR1', () => {
    ...
    it('can return its Bernstein decomposition', () => {
        ...
        spline = spline.clamp(spline.knots[3])
        spline = spline.clamp(spline.knots[spline.knots.length - 3 - 1])
