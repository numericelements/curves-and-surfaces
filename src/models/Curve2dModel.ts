...
import { QuasiNewtonOptimizer } from "../optimizers/QuasiNewtonOptimizer"
...
export class Curve2dModel extends BaseCurve2dModel {
    ...
    constructor() {
        ...
        */
        ...
        this.optimizationProblem = new  OpBSplineR1toR2(this._spline.clone(), this._spline.clone(), this.activeControl)
