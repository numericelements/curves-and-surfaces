...
import { PeriodicBSplineR1toR2, create_PeriodicBSplineR1toR2 } from "../../bsplines/R1toR2/PeriodicBSplineR1toR2"
import { OpPeriodicBSplineR1toR2 } from "../../optimizationProblems/OpPeriodicBSplineR1toR2"
import { OpPeriodicBSplineR1toR2QuasiNewton } from "../../optimizationProblems/alternatives/OpPeriodicBSplineR1toR2QuasiNewton"


export class ClosedCurveModelAlternative01 extends BaseCurve2dModel {

    private _splineTarget: PeriodicBSplineR1toR2
    protected _spline: PeriodicBSplineR1toR2
    protected optimizationProblem: OpPeriodicBSplineR1toR2QuasiNewton
    ...
    constructor() {
        ...
        this.optimizationProblem = new  OpPeriodicBSplineR1toR2QuasiNewton(this._splineTarget.clone(), this._spline.clone(), this.activeControl)
    ...
    moveControlPoint(controlPointIndex: number, deltaX: number, deltaY: number) {
        this._splineTarget = this._splineTarget.moveControlPoint(controlPointIndex, new Vector2d(deltaX, deltaY))
