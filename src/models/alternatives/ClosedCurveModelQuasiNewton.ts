...
export class ClosedCurveModelQuasiNewton extends BaseCurve2dModel {
    ...
    constructor() {
        ...
        this.optimizationProblem = new  OpPeriodicBSplineR1toR2QuasiNewton(this._spline.clone(), this._spline.clone(), this.activeControl)
