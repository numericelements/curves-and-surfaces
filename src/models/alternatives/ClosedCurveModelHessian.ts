...
import { OpPeriodicBSplineR1toR2Hessian } from "../../optimizationProblems/alternatives/OpPeriodicBSplineR1toR2Hessian"
import { Optimizer } from "../../optimizers/Optimizer"
import { BaseCurve2dModel } from "../BaseCurve2dModel"

export class ClosedCurveModelHessian extends BaseCurve2dModel {

    protected _spline: PeriodicBSplineR1toR2
    protected optimizationProblem: OpPeriodicBSplineR1toR2Hessian
    ...
    constructor() {
        ...
        */
        ...
        this.optimizationProblem = new  OpPeriodicBSplineR1toR2Hessian(this._spline.clone(), this._spline.clone(), this.activeControl)
