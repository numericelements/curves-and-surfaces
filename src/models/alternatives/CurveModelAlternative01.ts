...
import { OpBSplineR1toR2} from "../../optimizationProblems/OpBSplineR1toR2"
import { OpBSplineR1toR2WithWeigthingFactors } from "../../optimizationProblems/OpBSplineR1toR2WithWeigthingFactors"
import { Optimizer } from "../../optimizers/Optimizer"
import { ActiveControl } from "../../optimizationProblems/BaseOpBSplineR1toR2"
import { BaseCurve2dModel } from "../BaseCurve2dModel"

export class CurveModelAlternative01 extends BaseCurve2dModel {

    private _splineTarget: BSplineR1toR2
    protected _spline: BSplineR1toR2

    protected optimizationProblem: OpBSplineR1toR2
    ...
    constructor() {
        ...
        this.optimizationProblem = new  OpBSplineR1toR2WithWeigthingFactors(this._splineTarget.clone(), this._spline.clone(), this.activeControl)
    ...
    moveControlPoint2(controlPointIndex: number, deltaX: number, deltaY: number) {
        this._splineTarget =  this._splineTarget.moveControlPoint(controlPointIndex, new Vector2d(deltaX, deltaY)) as BSplineR1toR2
