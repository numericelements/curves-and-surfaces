...
import { OpBSplineR1toR2QuasiNewton } from "../../optimizationProblems/alternatives/OpBSplineR1toR2QuasiNewton"

export class CurveModelQuasiNewton extends BaseCurve2dModel {

    protected _spline: BSplineR1toR2
    protected optimizationProblem: OpBSplineR1toR2QuasiNewton
    ...
    constructor() {
        ...
        */
        ...
        this.optimizationProblem = new  OpBSplineR1toR2QuasiNewton(this._spline.clone(), this._spline.clone(), this.activeControl)
