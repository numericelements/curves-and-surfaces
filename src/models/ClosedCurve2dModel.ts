...
import { OpPeriodicBSplineR1toR2Scaled } from "../optimizationProblems/OpPeriodicBSplineR1toR2Scaled"
import { Optimizer } from "../optimizers/Optimizer"
import { BaseCurve2dModel } from "./BaseCurve2dModel"



export class ClosedCurve2dModel extends BaseCurve2dModel {

    protected _spline: PeriodicBSplineR1toR2
    protected optimizationProblem: OpPeriodicBSplineR1toR2Scaled
    ...
    constructor() {
        ...
        this.optimizationProblem = new  OpPeriodicBSplineR1toR2Scaled(this._spline.clone(), this._spline.clone(), this.activeControl)
