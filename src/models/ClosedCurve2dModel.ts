...
export class ClosedCurve2dModel extends BaseCurve2dModel {
    ...
    protected optimizationProblem: OpPeriodicBSplineR1toR2
    ...
    constructor() {
        ...
        this.optimizationProblem = new  OpPeriodicBSplineR1toR2(this._spline.clone(), this._spline.clone(), this.activeControl)
