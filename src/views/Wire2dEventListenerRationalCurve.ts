import { RationalCurveScene2dView } from "./RationalCurveScene2dView"

export function Wire2dEventListenerRationalCurve(canvas: HTMLCanvasElement, curveSceneView: RationalCurveScene2dView) {
