...
export class ControlPolygon2dView implements IObserver<Readonly<IBSplineR1toR2>> {
    ...
    constructor(spline: IBSplineR1toR2, private controlPolygonShaders: ControlPolygon2dShaders, private closed: boolean,
    ...
    initVertexBuffers(gl: WebGLRenderingContext) {
        ...
        let a_Position = gl.getAttribLocation(<ControlPolygon2dShaders> this.controlPolygonShaders.program, 'a_Position')
    ...
    renderFrame() {
        ...
        const a_Position = gl.getAttribLocation(<ControlPolygon2dShaders>this.controlPolygonShaders.program, 'a_Position')
        const fColorLocation = gl.getUniformLocation(<ControlPolygon2dShaders>this.controlPolygonShaders.program, "fColor")
    ...
    update (message: Readonly<IBSplineR1toR2>) {
