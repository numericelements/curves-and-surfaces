...
export class ControlPoints3dView implements IObserver<BSplineR1toR3> {
    ...
    constructor(private spline: BSplineR1toR3, private controlPoints3dShaders: ControlPoints3dShaders, private lightDirection: number[]) {
    ...
    renderFrame() {
        let gl = this.controlPoints3dShaders.gl,
        a_Position = gl.getAttribLocation(<ControlPoints3dShaders>this.controlPoints3dShaders.program, 'a_Position'),
        a_Normal = gl.getAttribLocation(<ControlPoints3dShaders>this.controlPoints3dShaders.program, 'a_Normal'),
        a_Color = gl.getAttribLocation(<ControlPoints3dShaders>this.controlPoints3dShaders.program, 'a_Color'),
    ...
    initVertexBuffers(gl: WebGLRenderingContext) {
        ...
        let a_Position = gl.getAttribLocation(<ControlPoints3dShaders> this.controlPoints3dShaders.program, 'a_Position'),
            a_Normal = gl.getAttribLocation(<ControlPoints3dShaders>this.controlPoints3dShaders.program, 'a_Normal'),
            a_Color = gl.getAttribLocation(<ControlPoints3dShaders>this.controlPoints3dShaders.program, 'a_Color'),
            FSIZE = this.vertices.BYTES_PER_ELEMENT;
    ...
    setUniforms() {
        ...
        const ambientLoc = gl.getUniformLocation(<WebGLProgram> this.controlPoints3dShaders.program, "Ambient")
        const lightColorLoc = gl.getUniformLocation(<WebGLProgram> this.controlPoints3dShaders.program, "LightColor")

        const modelViewProjectionMatrixLoc = gl.getUniformLocation(<WebGLProgram> this.controlPoints3dShaders.program, "ModelViewProjectionMatrix")
        const normalMatrixLoc = gl.getUniformLocation(<WebGLProgram> this.controlPoints3dShaders.program, "NormalMatrix")
        const lightDirectionLoc = gl.getUniformLocation(<WebGLProgram> this.controlPoints3dShaders.program, "LightDirection")
        const halfVectorLoc = gl.getUniformLocation(<WebGLProgram> this.controlPoints3dShaders.program, "LightDirection")
        const shininessLoc = gl.getUniformLocation(<WebGLProgram> this.controlPoints3dShaders.program, "Shininess")
        const strengthLoc = gl.getUniformLocation(<WebGLProgram> this.controlPoints3dShaders.program, "Strength")
    ...
    projectionMatrix() {
        ...
        const canvas = this.controlPoints3dShaders.gl.canvas as HTMLCanvasElement
