...
export class Inflections2dView implements IObserver<IBSplineR1toR2> {
    ...
    constructor(spline: IBSplineR1toR2, private curvatureExtremaShaders: CurvatureExtremaShaders, private red: number, private green: number, private blue: number,  private alpha: number) {
