...
export class ControlPoints2dView implements IObserver<IBSplineR1toR2> {
    ...
    constructor(spline: IBSplineR1toR2, private controlPointsShaders: ControlPointsShaders, private red: number, private blue: number, private green: number ) {
