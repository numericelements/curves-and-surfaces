...
export class ControlPolygon3dShadowView implements IObserver<BSplineR1toR3> {
    ...
    constructor(spline: BSplineR1toR3, private controlPolygon3dShaders: ControlPolygon3dShadowShaders, private lightDirection: number[], private closed: boolean) {
    ...
    renderFrame() {
        ...
        a_Position = gl.getAttribLocation(<ControlPolygon3dShadowShaders>this.controlPolygon3dShaders.program, 'a_Position'),
        a_Normal = gl.getAttribLocation(<ControlPolygon3dShadowShaders>this.controlPolygon3dShaders.program, 'a_Normal'),
        a_Color = gl.getAttribLocation(<ControlPolygon3dShadowShaders>this.controlPolygon3dShaders.program, 'a_Color'),
    ...
    initVertexBuffers(gl: WebGLRenderingContext) {
        ...
        let a_Position = gl.getAttribLocation(<ControlPolygon3dShadowShaders> this.controlPolygon3dShaders.program, 'a_Position'),
            a_Normal = gl.getAttribLocation(<ControlPolygon3dShadowShaders>this.controlPolygon3dShaders.program, 'a_Normal'),
            a_Color = gl.getAttribLocation(<ControlPolygon3dShadowShaders>this.controlPolygon3dShaders.program, 'a_Color'),
            FSIZE = this.vertices.BYTES_PER_ELEMENT;
