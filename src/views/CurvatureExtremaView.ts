...
import { PeriodicBSplineR1toR2DifferentialProperties } from "../bsplines/PeriodicBSplineR1toR2DifferentialProperties";
...
export class CurvatureExtremaView implements IObserver<BSplineR1toR2Interface> {
    ...
    private curvatureExtrema: Vector2d[] = []

    constructor(spline: BSplineR1toR2Interface, private curvatureExtremaShaders: CurvatureExtremaShaders, private red: number, private green: number, private blue: number,  private alpha: number) {
