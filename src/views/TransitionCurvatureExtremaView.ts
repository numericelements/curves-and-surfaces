...
export class TransitionCurvatureExtremaView implements IObserver<BSplineR1toR2Interface> {
    ...
    constructor(spline: BSplineR1toR2Interface, private curvatureExtremaShaders: TransitionDifferentialEventShaders, private red: number, private green: number, private blue: number,  private alpha: number) {
