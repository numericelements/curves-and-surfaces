...
export class PhantomCurveView implements IObserver<BSplineR1toR2Interface> {

    private readonly POINT_SEQUENCE_SIZE = 1000;
    private readonly THICKNESS = 0.002;
    private readonly RED_COLOR = 10 / 255;
    private readonly GREEN_COLOR = 150 / 255;
    private readonly BLUE_COLOR = 10 / 255;
