...
import { OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors_no_inactive_constraints_inflection, ActiveControl } from "../mathematics/OptimizationProblem_BSpline_R1_to_R2_inflection";
...
export class NoSlidingStrategy implements CurveControlStrategyInterface {
    ...
    private optimizationProblem: OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors_no_inactive_constraints_inflection
    ...
    constructor(curveModel: CurveModel ) {
        ...
        this.optimizationProblem = new  OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors_no_inactive_constraints_inflection(this.curveModel.spline.clone(), this.curveModel.spline.clone())
        this.optimizer = this.newOptimizer(this.optimizationProblem)
    }

    setWeightingFactor(optimizationProblem: OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors_no_inactive_constraints_inflection) {
    ...
    newOptimizer(optimizationProblem: OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors_no_inactive_constraints_inflection) {
    ...
    toggleControlOfCurvatureExtrema(): void {
        if (this.activeOptimizer === false) {
            ...
            this.optimizationProblem = new  OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors_no_inactive_constraints_inflection(this.curveModel.spline.clone(), this.curveModel.spline.clone(), ActiveControl.curvatureExtrema)
            this.optimizer = this.newOptimizer(this.optimizationProblem)
        }
            ...
            this.optimizationProblem = new  OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors_no_inactive_constraints_inflection(this.curveModel.spline.clone(), this.curveModel.spline.clone(), ActiveControl.inflections)
            this.optimizer = this.newOptimizer(this.optimizationProblem)
        }
        else if (this.optimizationProblem.activeControl === ActiveControl.inflections ){
            this.optimizationProblem = new  OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors_no_inactive_constraints_inflection(this.curveModel.spline.clone(), this.curveModel.spline.clone(), ActiveControl.both)
            this.optimizer = this.newOptimizer(this.optimizationProblem)
        }
        else {
