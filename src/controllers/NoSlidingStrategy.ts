...
import { OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors, ActiveControl } from "../bsplineOptimizationProblems/OptimizationProblem_BSpline_R1_to_R2";
...
export class NoSlidingStrategy implements CurveControlStrategyInterface {
    ...
    private _optimizationProblem: OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors
    ...
    constructor(curveModel: CurveModel, controlOfInflection: boolean, controlOfCurvatureExtrema: boolean, activeLocationControl: ActiveLocationControl ) {
        ...
        this._optimizationProblem = new  OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors(this.curveModel.spline.clone(), this.curveModel.spline.clone(), activeControl)
    ...
    resetCurve(curveModel: CurveModel) {
        this.curveModel = curveModel
        this._optimizationProblem = new  OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors(this.curveModel.spline.clone(), this.curveModel.spline.clone())
    ...
    toggleControlOfCurvatureExtrema(): void {
        if (this.activeOptimizer === false) {
            ...
            this._optimizationProblem = new  OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors(this.curveModel.spline.clone(), this.curveModel.spline.clone(), ActiveControl.curvatureExtrema)
            this._optimizer = this.newOptimizer(this.optimizationProblem)
        }
            ...
            this._optimizationProblem = new  OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors(this.curveModel.spline.clone(), this.curveModel.spline.clone(), ActiveControl.inflections)
            this._optimizer = this.newOptimizer(this.optimizationProblem)
        }
        else if (this.optimizationProblem.activeControl === ActiveControl.inflections ){
            this._optimizationProblem = new  OptimizationProblem_BSpline_R1_to_R2_with_weigthingFactors(this.curveModel.spline.clone(), this.curveModel.spline.clone(), ActiveControl.both)
            this._optimizer = this.newOptimizer(this.optimizationProblem)
        }
        else {
