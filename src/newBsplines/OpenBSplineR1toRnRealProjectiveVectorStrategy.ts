...
// export class OpenBSplineR1toRnRealProjectiveVectorStrategy extends AbstractOPenBSplineR1toRnStrategy<ProjectiveVector, number> implements OpenBSplineR1toRnStrategy<ProjectiveVector, number> {

//     protected vectorSpace: ProjectiveVectorSpace;

//     constructor(curveParameters: BSpline_type, openSBplineR1toRn: OpenBSplineR1toRn<ProjectiveVector, number>) {
...
//             distances.push(this.vectorSpace.normDescriptor(this.vectorSpace.subtractDescriptors(this.openBSplineR1toRn.controlPolygon.getVector(i + 1) as ProjectiveVector, this.openBSplineR1toRn.controlPolygon.getVector(i) as ProjectiveVector)));
//         }
//         return distances;
//     }
...
//     derivative(): OpenBSplineR1toRn<ProjectiveVector, number> {
//         return this.openBSplineR1toRn;
//     }

//     bernsteinDecomposition(): OpenBSplineR1toRn<ProjectiveVector, number> {
//         return this.openBSplineR1toRn;
//     }
// }