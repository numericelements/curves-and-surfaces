...
export type VectorSpaceForType<VS extends VectorSpaceType, D extends number> =
    ...
    VS extends VectorSpaceType.PROJECTIVE ? ProjectiveRealVectorSpaceOfDimension<D> :
...
export type ProjectiveRealVectorSpaceOfDimension<D extends number> = 
    D extends 3 ? ProjectiveVectorSpace<3> :
    D extends 4 ? ProjectiveVectorSpace<4> :
    ProjectiveVectorSpace<D>;
