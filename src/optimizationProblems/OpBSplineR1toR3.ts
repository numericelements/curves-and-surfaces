...
import { ScaledBernsteinDecompositionR1toR1, determinant2by2 } from "../bsplines/R1toR1/ScaledBernsteinDecompositionR1toR1"
import { BaseOpBSplineR1toR3} from "./BaseOpBSplineR1toR3"
...
export class OpBSplineR1toR3 extends BaseOpBSplineR1toR3 {
    ...
    compute_curvatureExtremaConstraints_gradient( s: Derivatives,
            ...
            let dgz: ScaledBernsteinDecompositionR1toR1[] = []
