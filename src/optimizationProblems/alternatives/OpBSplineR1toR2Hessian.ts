...
export class OpBSplineR1toR2Hessian extends BaseOpProblemBSplineR1toR2 {
    ...
    constructor(target: BSplineR1toR2, initial: BSplineR1toR2, public activeControl: ActiveControl = ActiveControl.curvatureExtrema) {
        ...
        this._hessian_f = this.compute_hessian_f(e.bdsxu, e.bdsyu, e.bdsxuu, e.bdsyuu,e.bdsxuuu, e.bdsyuuu, e.cuDOTcu, e.cuXcuuu, e.cuDOTcuu, e.cuXcuu, this.curvatureExtremaConstraintsSign, this._curvatureExtremaInactiveConstraints)
    }
    ...
    compute_hessian_f( sxu: ScaledBernsteinDecompositionR1toR1, 
        syu: ScaledBernsteinDecompositionR1toR1, 
        sxuu: ScaledBernsteinDecompositionR1toR1, 
        syuu: ScaledBernsteinDecompositionR1toR1, 
        sxuuu: ScaledBernsteinDecompositionR1toR1, 
        syuuu: ScaledBernsteinDecompositionR1toR1, 
        h1: ScaledBernsteinDecompositionR1toR1, 
        h2: ScaledBernsteinDecompositionR1toR1, 
        h3: ScaledBernsteinDecompositionR1toR1, 
        h4: ScaledBernsteinDecompositionR1toR1,
        constraintsSign: number[], 
        inactiveConstraints: number[]) {

        if (this.activeControl === ActiveControl.both || this.activeControl === ActiveControl.inflections) {
            return undefined
        }
